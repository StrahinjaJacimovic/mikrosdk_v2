...
sfr unsigned short volatile DFLTCON          absolute 0xF60;
...
sfr unsigned short          CAP3CON          absolute 0xF61;
...
sfr unsigned short          CAP2CON          absolute 0xF62;
...
sfr unsigned short          CAP1CON          absolute 0xF63;
...
sfr unsigned short          CAP3BUFL         absolute 0xF64;
sfr unsigned short volatile MAXCNTL          absolute 0xF64;
sfr unsigned short          CAP3BUFH         absolute 0xF65;
sfr unsigned short volatile MAXCNTH          absolute 0xF65;
sfr unsigned short          CAP2BUFL         absolute 0xF66;
sfr unsigned short volatile POSCNTL          absolute 0xF66;
sfr unsigned short          CAP2BUFH         absolute 0xF67;
sfr unsigned short volatile POSCNTH          absolute 0xF67;
sfr unsigned short          CAP1BUFL         absolute 0xF68;
sfr unsigned short volatile VELRL            absolute 0xF68;
sfr unsigned short          CAP1BUFH         absolute 0xF69;
sfr unsigned short volatile VELRH            absolute 0xF69;
sfr unsigned short volatile OVDCONS          absolute 0xF6A;
...
sfr unsigned short volatile OVDCOND          absolute 0xF6B;
...
sfr unsigned short volatile FLTCONFIG        absolute 0xF6C;
...
sfr unsigned short volatile DTCON            absolute 0xF6D;
...
sfr unsigned short          PWMCON1          absolute 0xF6E;
...
sfr unsigned short          PWMCON0          absolute 0xF6F;
...
sfr unsigned short volatile SEVTCMPH         absolute 0xF70;
sfr unsigned short volatile SEVTCMPL         absolute 0xF71;
sfr unsigned short volatile PDC3H            absolute 0xF72;
sfr unsigned short volatile PDC3L            absolute 0xF73;
sfr unsigned short volatile PDC2H            absolute 0xF74;
sfr unsigned short volatile PDC2L            absolute 0xF75;
sfr unsigned short volatile PDC1H            absolute 0xF76;
sfr unsigned short volatile PDC1L            absolute 0xF77;
sfr unsigned short volatile PDC0H            absolute 0xF78;
sfr unsigned short volatile PDC0L            absolute 0xF79;
sfr unsigned short volatile PTPERH           absolute 0xF7A;
sfr unsigned short volatile PTPERL           absolute 0xF7B;
sfr unsigned short volatile PTMRH            absolute 0xF7C;
sfr unsigned short volatile PTMRL            absolute 0xF7D;
sfr unsigned short volatile PTCON1           absolute 0xF7E;
...
sfr unsigned short volatile PTCON0           absolute 0xF7F;
...
sfr unsigned short volatile PORTC            absolute 0xF82;
    ...
    const register unsigned short int nFLTA = 1;
    sbit  nFLTA_bit at PORTC.B1;
    const register unsigned short int nFLTB = 2;
    sbit  nFLTB_bit at PORTC.B2;
    const register unsigned short int nSS = 6;
    sbit  nSS_bit at PORTC.B6;
...
sfr unsigned int   volatile TMR5             absolute 0xF87;
sfr unsigned short volatile TMR5L            absolute 0xF87;
sfr unsigned short volatile TMR5H            absolute 0xF88;
...
sfr unsigned int   volatile PR5              absolute 0xF90;
sfr unsigned short volatile PR5L             absolute 0xF90;
sfr unsigned short volatile PR5H             absolute 0xF91;
...
sfr unsigned short          ADCHS            absolute 0xF99;
...
sfr unsigned short volatile ADCON3           absolute 0xF9A;
...
sfr unsigned short          BAUDCON          absolute 0xFAA;
...
sfr unsigned short          BAUDCTL          absolute 0xFAA;
...
sfr unsigned short volatile QEICON           absolute 0xFB6;
    ...
    const register unsigned short int UP_nDOWN = 5;
    sbit  UP_nDOWN_bit at QEICON.B5;
    const register unsigned short int VELM = 7;
    sbit  VELM_bit at QEICON.B7;
    const register unsigned short int nDOWN = 5;
    sbit  nDOWN_bit at QEICON.B5;
    const register unsigned short int nVELM = 7;
    sbit  nVELM_bit at QEICON.B7;

sfr unsigned short volatile T5CON            absolute 0xFB7;
    ...
    const register unsigned short int SOSCEN5 = 3;
    sbit  SOSCEN5_bit at T5CON.B3;
    ...
    const register unsigned short int nRESEN = 6;
    sbit  nRESEN_bit at T5CON.B6;
    const register unsigned short int nT5SYNC = 2;
    sbit  nT5SYNC_bit at T5CON.B2;

sfr unsigned short          ANSEL0           absolute 0xFB8;
...
sfr unsigned short          ANSEL1           absolute 0xFB9;
...
sfr unsigned short volatile SSPCON           absolute 0xFC6;
