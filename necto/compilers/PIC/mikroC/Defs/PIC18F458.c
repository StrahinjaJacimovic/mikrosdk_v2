...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    sbit  C1INP_bit at PORTD.B0;

    // Alternative bit function
    const register unsigned short int C1INM = 1;
    sbit  C1INM_bit at PORTD.B1;

    // Alternative bit function
    const register unsigned short int C2INP = 2;
    sbit  C2INP_bit at PORTD.B2;

    // Alternative bit function
    const register unsigned short int C2INM = 3;
    sbit  C2INM_bit at PORTD.B3;
    ...
    // ECCP1DEL bits
    const register unsigned short int EPDC0 = 0;
    sbit  EPDC0_bit at ECCP1DEL.B0;
    const register unsigned short int EPDC1 = 1;
    sbit  EPDC1_bit at ECCP1DEL.B1;
    const register unsigned short int EPDC2 = 2;
    sbit  EPDC2_bit at ECCP1DEL.B2;
    const register unsigned short int EPDC3 = 3;
    sbit  EPDC3_bit at ECCP1DEL.B3;
    const register unsigned short int EPDC4 = 4;
    sbit  EPDC4_bit at ECCP1DEL.B4;
    const register unsigned short int EPDC5 = 5;
    sbit  EPDC5_bit at ECCP1DEL.B5;
    const register unsigned short int EPDC6 = 6;
    sbit  EPDC6_bit at ECCP1DEL.B6;
    const register unsigned short int EPDC7 = 7;
    sbit  EPDC7_bit at ECCP1DEL.B7;
    ...
    const register unsigned short int EDC2B0 = 4;
    sbit  EDC2B0_bit at ECCP1CON.B4;
    const register unsigned short int EDC2B1 = 5;
    sbit  EDC2B1_bit at ECCP1CON.B5;
