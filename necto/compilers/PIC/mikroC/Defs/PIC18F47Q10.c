...
sfr unsigned short volatile CLCIN0PPS        absolute 0xE1F;
...
sfr unsigned short volatile CLCIN1PPS        absolute 0xE20;
...
sfr unsigned short volatile CLCIN2PPS        absolute 0xE21;
...
sfr unsigned short volatile CLCIN3PPS        absolute 0xE22;
...
sfr unsigned short volatile CLCIN4PPS        absolute 0xE23;
...
sfr unsigned short volatile CLCIN5PPS        absolute 0xE24;
...
sfr unsigned short volatile CLCIN6PPS        absolute 0xE25;
...
sfr unsigned short volatile CLCIN7PPS        absolute 0xE26;
...
sfr unsigned short volatile CLC1CON          absolute 0xE27;
...
sfr unsigned short volatile CLC1POL          absolute 0xE28;
...
sfr unsigned short volatile CLC1SEL0         absolute 0xE29;
...
sfr unsigned short volatile CLC1SEL1         absolute 0xE2A;
...
sfr unsigned short volatile CLC1SEL2         absolute 0xE2B;
...
sfr unsigned short volatile CLC1SEL3         absolute 0xE2C;
...
sfr unsigned short volatile CLC1GLS0         absolute 0xE2D;
...
sfr unsigned short volatile CLC1GLS1         absolute 0xE2E;
...
sfr unsigned short volatile CLC1GLS2         absolute 0xE2F;
...
sfr unsigned short volatile CLC1GLS3         absolute 0xE30;
...
sfr unsigned short volatile CLC2CON          absolute 0xE31;
...
sfr unsigned short volatile CLC2POL          absolute 0xE32;
...
sfr unsigned short volatile CLC2SEL0         absolute 0xE33;
...
sfr unsigned short volatile CLC2SEL1         absolute 0xE34;
...
sfr unsigned short volatile CLC2SEL2         absolute 0xE35;
...
sfr unsigned short volatile CLC2SEL3         absolute 0xE36;
...
sfr unsigned short volatile CLC2GLS0         absolute 0xE37;
...
sfr unsigned short volatile CLC2GLS1         absolute 0xE38;
...
sfr unsigned short volatile CLC2GLS2         absolute 0xE39;
...
sfr unsigned short volatile CLC2GLS3         absolute 0xE3A;
...
sfr unsigned short volatile CLC3CON          absolute 0xE3B;
...
sfr unsigned short volatile CLC3POL          absolute 0xE3C;
...
sfr unsigned short volatile CLC3SEL0         absolute 0xE3D;
...
sfr unsigned short volatile CLC3SEL1         absolute 0xE3E;
...
sfr unsigned short volatile CLC3SEL2         absolute 0xE3F;
...
sfr unsigned short volatile CLC3SEL3         absolute 0xE40;
...
sfr unsigned short volatile CLC3GLS0         absolute 0xE41;
...
sfr unsigned short volatile CLC3GLS1         absolute 0xE42;
...
sfr unsigned short volatile CLC3GLS2         absolute 0xE43;
...
sfr unsigned short volatile CLC3GLS3         absolute 0xE44;
...
sfr unsigned short volatile CLC4CON          absolute 0xE45;
...
sfr unsigned short volatile CLC4POL          absolute 0xE46;
...
sfr unsigned short volatile CLC4SEL0         absolute 0xE47;
...
sfr unsigned short volatile CLC4SEL1         absolute 0xE48;
...
sfr unsigned short volatile CLC4SEL2         absolute 0xE49;
...
sfr unsigned short volatile CLC4SEL3         absolute 0xE4A;
...
sfr unsigned short volatile CLC4GLS0         absolute 0xE4B;
...
sfr unsigned short volatile CLC4GLS1         absolute 0xE4C;
...
sfr unsigned short volatile CLC4GLS2         absolute 0xE4D;
...
sfr unsigned short volatile CLC4GLS3         absolute 0xE4E;
...
sfr unsigned short volatile CLC5CON          absolute 0xE4F;
    const register unsigned short int LC5MODE0 = 0;
    sbit  LC5MODE0_bit at CLC5CON.B0;
    const register unsigned short int LC5MODE1 = 1;
    sbit  LC5MODE1_bit at CLC5CON.B1;
    const register unsigned short int LC5MODE2 = 2;
    sbit  LC5MODE2_bit at CLC5CON.B2;
    const register unsigned short int LC5INTN = 3;
    sbit  LC5INTN_bit at CLC5CON.B3;
    const register unsigned short int LC5INTP = 4;
    sbit  LC5INTP_bit at CLC5CON.B4;
    const register unsigned short int LC5OUT = 5;
    sbit  LC5OUT_bit at CLC5CON.B5;
    const register unsigned short int LC5EN = 7;
    sbit  LC5EN_bit at CLC5CON.B7;

sfr unsigned short volatile CLC5POL          absolute 0xE50;
    const register unsigned short int LC5G1POL = 0;
    sbit  LC5G1POL_bit at CLC5POL.B0;
    const register unsigned short int LC5G2POL = 1;
    sbit  LC5G2POL_bit at CLC5POL.B1;
    const register unsigned short int LC5G3POL = 2;
    sbit  LC5G3POL_bit at CLC5POL.B2;
    const register unsigned short int LC5G4POL = 3;
    sbit  LC5G4POL_bit at CLC5POL.B3;
    const register unsigned short int LC5POL = 7;
    sbit  LC5POL_bit at CLC5POL.B7;

sfr unsigned short volatile CLC5SEL0         absolute 0xE51;
    const register unsigned short int LC5D1S0 = 0;
    sbit  LC5D1S0_bit at CLC5SEL0.B0;
    const register unsigned short int LC5D1S1 = 1;
    sbit  LC5D1S1_bit at CLC5SEL0.B1;
    const register unsigned short int LC5D1S2 = 2;
    sbit  LC5D1S2_bit at CLC5SEL0.B2;
    const register unsigned short int LC5D1S3 = 3;
    sbit  LC5D1S3_bit at CLC5SEL0.B3;
    const register unsigned short int LC5D1S4 = 4;
    sbit  LC5D1S4_bit at CLC5SEL0.B4;
    const register unsigned short int LC5D1S5 = 5;
    sbit  LC5D1S5_bit at CLC5SEL0.B5;
    const register unsigned short int LC5D1S6 = 6;
    sbit  LC5D1S6_bit at CLC5SEL0.B6;
    const register unsigned short int LC5D1S7 = 7;
    sbit  LC5D1S7_bit at CLC5SEL0.B7;

sfr unsigned short volatile CLC5SEL1         absolute 0xE52;
    const register unsigned short int LC5D2S0 = 0;
    sbit  LC5D2S0_bit at CLC5SEL1.B0;
    const register unsigned short int LC5D2S1 = 1;
    sbit  LC5D2S1_bit at CLC5SEL1.B1;
    const register unsigned short int LC5D2S2 = 2;
    sbit  LC5D2S2_bit at CLC5SEL1.B2;
    const register unsigned short int LC5D2S3 = 3;
    sbit  LC5D2S3_bit at CLC5SEL1.B3;
    const register unsigned short int LC5D2S4 = 4;
    sbit  LC5D2S4_bit at CLC5SEL1.B4;
    const register unsigned short int LC5D2S5 = 5;
    sbit  LC5D2S5_bit at CLC5SEL1.B5;
    const register unsigned short int LC5D2S6 = 6;
    sbit  LC5D2S6_bit at CLC5SEL1.B6;
    const register unsigned short int LC5D2S7 = 7;
    sbit  LC5D2S7_bit at CLC5SEL1.B7;

sfr unsigned short volatile CLC5SEL2         absolute 0xE53;
    const register unsigned short int LC5D3S0 = 0;
    sbit  LC5D3S0_bit at CLC5SEL2.B0;
    const register unsigned short int LC5D3S1 = 1;
    sbit  LC5D3S1_bit at CLC5SEL2.B1;
    const register unsigned short int LC5D3S2 = 2;
    sbit  LC5D3S2_bit at CLC5SEL2.B2;
    const register unsigned short int LC5D3S3 = 3;
    sbit  LC5D3S3_bit at CLC5SEL2.B3;
    const register unsigned short int LC5D3S4 = 4;
    sbit  LC5D3S4_bit at CLC5SEL2.B4;
    const register unsigned short int LC5D3S5 = 5;
    sbit  LC5D3S5_bit at CLC5SEL2.B5;
    const register unsigned short int LC5D3S6 = 6;
    sbit  LC5D3S6_bit at CLC5SEL2.B6;
    const register unsigned short int LC5D3S7 = 7;
    sbit  LC5D3S7_bit at CLC5SEL2.B7;

sfr unsigned short volatile CLC5SEL3         absolute 0xE54;
    const register unsigned short int LC5D4S0 = 0;
    sbit  LC5D4S0_bit at CLC5SEL3.B0;
    const register unsigned short int LC5D4S1 = 1;
    sbit  LC5D4S1_bit at CLC5SEL3.B1;
    const register unsigned short int LC5D4S2 = 2;
    sbit  LC5D4S2_bit at CLC5SEL3.B2;
    const register unsigned short int LC5D4S3 = 3;
    sbit  LC5D4S3_bit at CLC5SEL3.B3;
    const register unsigned short int LC5D4S4 = 4;
    sbit  LC5D4S4_bit at CLC5SEL3.B4;
    const register unsigned short int LC5D4S5 = 5;
    sbit  LC5D4S5_bit at CLC5SEL3.B5;
    const register unsigned short int LC5D4S6 = 6;
    sbit  LC5D4S6_bit at CLC5SEL3.B6;
    const register unsigned short int LC5D4S7 = 7;
    sbit  LC5D4S7_bit at CLC5SEL3.B7;

sfr unsigned short volatile CLC5GLS0         absolute 0xE55;
    const register unsigned short int LC5G1D1N = 0;
    sbit  LC5G1D1N_bit at CLC5GLS0.B0;
    const register unsigned short int LC5G1D1T = 1;
    sbit  LC5G1D1T_bit at CLC5GLS0.B1;
    const register unsigned short int LC5G1D2N = 2;
    sbit  LC5G1D2N_bit at CLC5GLS0.B2;
    const register unsigned short int LC5G1D2T = 3;
    sbit  LC5G1D2T_bit at CLC5GLS0.B3;
    const register unsigned short int LC5G1D3N = 4;
    sbit  LC5G1D3N_bit at CLC5GLS0.B4;
    const register unsigned short int LC5G1D3T = 5;
    sbit  LC5G1D3T_bit at CLC5GLS0.B5;
    const register unsigned short int LC5G1D4N = 6;
    sbit  LC5G1D4N_bit at CLC5GLS0.B6;
    const register unsigned short int LC5G1D4T = 7;
    sbit  LC5G1D4T_bit at CLC5GLS0.B7;

sfr unsigned short volatile CLC5GLS1         absolute 0xE56;
    const register unsigned short int LC5G2D1N = 0;
    sbit  LC5G2D1N_bit at CLC5GLS1.B0;
    const register unsigned short int LC5G2D1T = 1;
    sbit  LC5G2D1T_bit at CLC5GLS1.B1;
    const register unsigned short int LC5G2D2N = 2;
    sbit  LC5G2D2N_bit at CLC5GLS1.B2;
    const register unsigned short int LC5G2D2T = 3;
    sbit  LC5G2D2T_bit at CLC5GLS1.B3;
    const register unsigned short int LC5G2D3N = 4;
    sbit  LC5G2D3N_bit at CLC5GLS1.B4;
    const register unsigned short int LC5G2D3T = 5;
    sbit  LC5G2D3T_bit at CLC5GLS1.B5;
    const register unsigned short int LC5G2D4N = 6;
    sbit  LC5G2D4N_bit at CLC5GLS1.B6;
    const register unsigned short int LC5G2D4T = 7;
    sbit  LC5G2D4T_bit at CLC5GLS1.B7;

sfr unsigned short volatile CLC5GLS2         absolute 0xE57;
    const register unsigned short int LC5G3D1N = 0;
    sbit  LC5G3D1N_bit at CLC5GLS2.B0;
    const register unsigned short int LC5G3D1T = 1;
    sbit  LC5G3D1T_bit at CLC5GLS2.B1;
    const register unsigned short int LC5G3D2N = 2;
    sbit  LC5G3D2N_bit at CLC5GLS2.B2;
    const register unsigned short int LC5G3D2T = 3;
    sbit  LC5G3D2T_bit at CLC5GLS2.B3;
    const register unsigned short int LC5G3D3N = 4;
    sbit  LC5G3D3N_bit at CLC5GLS2.B4;
    const register unsigned short int LC5G3D3T = 5;
    sbit  LC5G3D3T_bit at CLC5GLS2.B5;
    const register unsigned short int LC5G3D4N = 6;
    sbit  LC5G3D4N_bit at CLC5GLS2.B6;
    const register unsigned short int LC5G3D4T = 7;
    sbit  LC5G3D4T_bit at CLC5GLS2.B7;

sfr unsigned short volatile CLC5GLS3         absolute 0xE58;
    const register unsigned short int LC5G4D1N = 0;
    sbit  LC5G4D1N_bit at CLC5GLS3.B0;
    const register unsigned short int LC5G4D1T = 1;
    sbit  LC5G4D1T_bit at CLC5GLS3.B1;
    const register unsigned short int LC5G4D2N = 2;
    sbit  LC5G4D2N_bit at CLC5GLS3.B2;
    const register unsigned short int LC5G4D2T = 3;
    sbit  LC5G4D2T_bit at CLC5GLS3.B3;
    const register unsigned short int LC5G4D3N = 4;
    sbit  LC5G4D3N_bit at CLC5GLS3.B4;
    const register unsigned short int LC5G4D3T = 5;
    sbit  LC5G4D3T_bit at CLC5GLS3.B5;
    const register unsigned short int LC5G4D4N = 6;
    sbit  LC5G4D4N_bit at CLC5GLS3.B6;
    const register unsigned short int LC5G4D4T = 7;
    sbit  LC5G4D4T_bit at CLC5GLS3.B7;

sfr unsigned short volatile CLC6CON          absolute 0xE59;
    const register unsigned short int LC6MODE0 = 0;
    sbit  LC6MODE0_bit at CLC6CON.B0;
    const register unsigned short int LC6MODE1 = 1;
    sbit  LC6MODE1_bit at CLC6CON.B1;
    const register unsigned short int LC6MODE2 = 2;
    sbit  LC6MODE2_bit at CLC6CON.B2;
    const register unsigned short int LC6INTN = 3;
    sbit  LC6INTN_bit at CLC6CON.B3;
    const register unsigned short int LC6INTP = 4;
    sbit  LC6INTP_bit at CLC6CON.B4;
    const register unsigned short int LC6OUT = 5;
    sbit  LC6OUT_bit at CLC6CON.B5;
    const register unsigned short int LC6EN = 7;
    sbit  LC6EN_bit at CLC6CON.B7;

sfr unsigned short volatile CLC6POL          absolute 0xE5A;
    const register unsigned short int LC6G1POL = 0;
    sbit  LC6G1POL_bit at CLC6POL.B0;
    const register unsigned short int LC6G2POL = 1;
    sbit  LC6G2POL_bit at CLC6POL.B1;
    const register unsigned short int LC6G3POL = 2;
    sbit  LC6G3POL_bit at CLC6POL.B2;
    const register unsigned short int LC6G4POL = 3;
    sbit  LC6G4POL_bit at CLC6POL.B3;
    const register unsigned short int LC6POL = 7;
    sbit  LC6POL_bit at CLC6POL.B7;

sfr unsigned short volatile CLC6SEL0         absolute 0xE5B;
    const register unsigned short int LC6D1S0 = 0;
    sbit  LC6D1S0_bit at CLC6SEL0.B0;
    const register unsigned short int LC6D1S1 = 1;
    sbit  LC6D1S1_bit at CLC6SEL0.B1;
    const register unsigned short int LC6D1S2 = 2;
    sbit  LC6D1S2_bit at CLC6SEL0.B2;
    const register unsigned short int LC6D1S3 = 3;
    sbit  LC6D1S3_bit at CLC6SEL0.B3;
    const register unsigned short int LC6D1S4 = 4;
    sbit  LC6D1S4_bit at CLC6SEL0.B4;
    const register unsigned short int LC6D1S5 = 5;
    sbit  LC6D1S5_bit at CLC6SEL0.B5;
    const register unsigned short int LC6D1S6 = 6;
    sbit  LC6D1S6_bit at CLC6SEL0.B6;
    const register unsigned short int LC6D1S7 = 7;
    sbit  LC6D1S7_bit at CLC6SEL0.B7;

sfr unsigned short volatile CLC6SEL1         absolute 0xE5C;
    const register unsigned short int LC6D2S0 = 0;
    sbit  LC6D2S0_bit at CLC6SEL1.B0;
    const register unsigned short int LC6D2S1 = 1;
    sbit  LC6D2S1_bit at CLC6SEL1.B1;
    const register unsigned short int LC6D2S2 = 2;
    sbit  LC6D2S2_bit at CLC6SEL1.B2;
    const register unsigned short int LC6D2S3 = 3;
    sbit  LC6D2S3_bit at CLC6SEL1.B3;
    const register unsigned short int LC6D2S4 = 4;
    sbit  LC6D2S4_bit at CLC6SEL1.B4;
    const register unsigned short int LC6D2S5 = 5;
    sbit  LC6D2S5_bit at CLC6SEL1.B5;
    const register unsigned short int LC6D2S6 = 6;
    sbit  LC6D2S6_bit at CLC6SEL1.B6;
    const register unsigned short int LC6D2S7 = 7;
    sbit  LC6D2S7_bit at CLC6SEL1.B7;

sfr unsigned short volatile CLC6SEL2         absolute 0xE5D;
    const register unsigned short int LC6D3S0 = 0;
    sbit  LC6D3S0_bit at CLC6SEL2.B0;
    const register unsigned short int LC6D3S1 = 1;
    sbit  LC6D3S1_bit at CLC6SEL2.B1;
    const register unsigned short int LC6D3S2 = 2;
    sbit  LC6D3S2_bit at CLC6SEL2.B2;
    const register unsigned short int LC6D3S3 = 3;
    sbit  LC6D3S3_bit at CLC6SEL2.B3;
    const register unsigned short int LC6D3S4 = 4;
    sbit  LC6D3S4_bit at CLC6SEL2.B4;
    const register unsigned short int LC6D3S5 = 5;
    sbit  LC6D3S5_bit at CLC6SEL2.B5;
    const register unsigned short int LC6D3S6 = 6;
    sbit  LC6D3S6_bit at CLC6SEL2.B6;
    const register unsigned short int LC6D3S7 = 7;
    sbit  LC6D3S7_bit at CLC6SEL2.B7;

sfr unsigned short volatile CLC6SEL3         absolute 0xE5E;
    const register unsigned short int LC6D4S0 = 0;
    sbit  LC6D4S0_bit at CLC6SEL3.B0;
    const register unsigned short int LC6D4S1 = 1;
    sbit  LC6D4S1_bit at CLC6SEL3.B1;
    const register unsigned short int LC6D4S2 = 2;
    sbit  LC6D4S2_bit at CLC6SEL3.B2;
    const register unsigned short int LC6D4S3 = 3;
    sbit  LC6D4S3_bit at CLC6SEL3.B3;
    const register unsigned short int LC6D4S4 = 4;
    sbit  LC6D4S4_bit at CLC6SEL3.B4;
    const register unsigned short int LC6D4S5 = 5;
    sbit  LC6D4S5_bit at CLC6SEL3.B5;
    const register unsigned short int LC6D4S6 = 6;
    sbit  LC6D4S6_bit at CLC6SEL3.B6;
    const register unsigned short int LC6D4S7 = 7;
    sbit  LC6D4S7_bit at CLC6SEL3.B7;

sfr unsigned short volatile CLC6GLS0         absolute 0xE5F;
    const register unsigned short int LC6G1D1N = 0;
    sbit  LC6G1D1N_bit at CLC6GLS0.B0;
    const register unsigned short int LC6G1D1T = 1;
    sbit  LC6G1D1T_bit at CLC6GLS0.B1;
    const register unsigned short int LC6G1D2N = 2;
    sbit  LC6G1D2N_bit at CLC6GLS0.B2;
    const register unsigned short int LC6G1D2T = 3;
    sbit  LC6G1D2T_bit at CLC6GLS0.B3;
    const register unsigned short int LC6G1D3N = 4;
    sbit  LC6G1D3N_bit at CLC6GLS0.B4;
    const register unsigned short int LC6G1D3T = 5;
    sbit  LC6G1D3T_bit at CLC6GLS0.B5;
    const register unsigned short int LC6G1D4N = 6;
    sbit  LC6G1D4N_bit at CLC6GLS0.B6;
    const register unsigned short int LC6G1D4T = 7;
    sbit  LC6G1D4T_bit at CLC6GLS0.B7;

sfr unsigned short volatile CLC6GLS1         absolute 0xE60;
    const register unsigned short int LC6G2D1N = 0;
    sbit  LC6G2D1N_bit at CLC6GLS1.B0;
    const register unsigned short int LC6G2D1T = 1;
    sbit  LC6G2D1T_bit at CLC6GLS1.B1;
    const register unsigned short int LC6G2D2N = 2;
    sbit  LC6G2D2N_bit at CLC6GLS1.B2;
    const register unsigned short int LC6G2D2T = 3;
    sbit  LC6G2D2T_bit at CLC6GLS1.B3;
    const register unsigned short int LC6G2D3N = 4;
    sbit  LC6G2D3N_bit at CLC6GLS1.B4;
    const register unsigned short int LC6G2D3T = 5;
    sbit  LC6G2D3T_bit at CLC6GLS1.B5;
    const register unsigned short int LC6G2D4N = 6;
    sbit  LC6G2D4N_bit at CLC6GLS1.B6;
    const register unsigned short int LC6G2D4T = 7;
    sbit  LC6G2D4T_bit at CLC6GLS1.B7;

sfr unsigned short volatile CLC6GLS2         absolute 0xE61;
    const register unsigned short int LC6G3D1N = 0;
    sbit  LC6G3D1N_bit at CLC6GLS2.B0;
    const register unsigned short int LC6G3D1T = 1;
    sbit  LC6G3D1T_bit at CLC6GLS2.B1;
    const register unsigned short int LC6G3D2N = 2;
    sbit  LC6G3D2N_bit at CLC6GLS2.B2;
    const register unsigned short int LC6G3D2T = 3;
    sbit  LC6G3D2T_bit at CLC6GLS2.B3;
    const register unsigned short int LC6G3D3N = 4;
    sbit  LC6G3D3N_bit at CLC6GLS2.B4;
    const register unsigned short int LC6G3D3T = 5;
    sbit  LC6G3D3T_bit at CLC6GLS2.B5;
    const register unsigned short int LC6G3D4N = 6;
    sbit  LC6G3D4N_bit at CLC6GLS2.B6;
    const register unsigned short int LC6G3D4T = 7;
    sbit  LC6G3D4T_bit at CLC6GLS2.B7;

sfr unsigned short volatile CLC6GLS3         absolute 0xE62;
    const register unsigned short int LC6G4D1N = 0;
    sbit  LC6G4D1N_bit at CLC6GLS3.B0;
    const register unsigned short int LC6G4D1T = 1;
    sbit  LC6G4D1T_bit at CLC6GLS3.B1;
    const register unsigned short int LC6G4D2N = 2;
    sbit  LC6G4D2N_bit at CLC6GLS3.B2;
    const register unsigned short int LC6G4D2T = 3;
    sbit  LC6G4D2T_bit at CLC6GLS3.B3;
    const register unsigned short int LC6G4D3N = 4;
    sbit  LC6G4D3N_bit at CLC6GLS3.B4;
    const register unsigned short int LC6G4D3T = 5;
    sbit  LC6G4D3T_bit at CLC6GLS3.B5;
    const register unsigned short int LC6G4D4N = 6;
    sbit  LC6G4D4N_bit at CLC6GLS3.B6;
    const register unsigned short int LC6G4D4T = 7;
    sbit  LC6G4D4T_bit at CLC6GLS3.B7;

sfr unsigned short volatile CLC7CON          absolute 0xE63;
    const register unsigned short int LC7MODE0 = 0;
    sbit  LC7MODE0_bit at CLC7CON.B0;
    const register unsigned short int LC7MODE1 = 1;
    sbit  LC7MODE1_bit at CLC7CON.B1;
    const register unsigned short int LC7MODE2 = 2;
    sbit  LC7MODE2_bit at CLC7CON.B2;
    const register unsigned short int LC7INTN = 3;
    sbit  LC7INTN_bit at CLC7CON.B3;
    const register unsigned short int LC7INTP = 4;
    sbit  LC7INTP_bit at CLC7CON.B4;
    const register unsigned short int LC7OUT = 5;
    sbit  LC7OUT_bit at CLC7CON.B5;
    const register unsigned short int LC7EN = 7;
    sbit  LC7EN_bit at CLC7CON.B7;

sfr unsigned short volatile CLC7POL          absolute 0xE64;
    const register unsigned short int LC7G1POL = 0;
    sbit  LC7G1POL_bit at CLC7POL.B0;
    const register unsigned short int LC7G2POL = 1;
    sbit  LC7G2POL_bit at CLC7POL.B1;
    const register unsigned short int LC7G3POL = 2;
    sbit  LC7G3POL_bit at CLC7POL.B2;
    const register unsigned short int LC7G4POL = 3;
    sbit  LC7G4POL_bit at CLC7POL.B3;
    const register unsigned short int LC7POL = 7;
    sbit  LC7POL_bit at CLC7POL.B7;

sfr unsigned short volatile CLC7SEL0         absolute 0xE65;
    const register unsigned short int LC7D1S0 = 0;
    sbit  LC7D1S0_bit at CLC7SEL0.B0;
    const register unsigned short int LC7D1S1 = 1;
    sbit  LC7D1S1_bit at CLC7SEL0.B1;
    const register unsigned short int LC7D1S2 = 2;
    sbit  LC7D1S2_bit at CLC7SEL0.B2;
    const register unsigned short int LC7D1S3 = 3;
    sbit  LC7D1S3_bit at CLC7SEL0.B3;
    const register unsigned short int LC7D1S4 = 4;
    sbit  LC7D1S4_bit at CLC7SEL0.B4;
    const register unsigned short int LC7D1S5 = 5;
    sbit  LC7D1S5_bit at CLC7SEL0.B5;
    const register unsigned short int LC7D1S6 = 6;
    sbit  LC7D1S6_bit at CLC7SEL0.B6;
    const register unsigned short int LC7D1S7 = 7;
    sbit  LC7D1S7_bit at CLC7SEL0.B7;

sfr unsigned short volatile CLC7SEL1         absolute 0xE66;
    const register unsigned short int LC7D2S0 = 0;
    sbit  LC7D2S0_bit at CLC7SEL1.B0;
    const register unsigned short int LC7D2S1 = 1;
    sbit  LC7D2S1_bit at CLC7SEL1.B1;
    const register unsigned short int LC7D2S2 = 2;
    sbit  LC7D2S2_bit at CLC7SEL1.B2;
    const register unsigned short int LC7D2S3 = 3;
    sbit  LC7D2S3_bit at CLC7SEL1.B3;
    const register unsigned short int LC7D2S4 = 4;
    sbit  LC7D2S4_bit at CLC7SEL1.B4;
    const register unsigned short int LC7D2S5 = 5;
    sbit  LC7D2S5_bit at CLC7SEL1.B5;
    const register unsigned short int LC7D2S6 = 6;
    sbit  LC7D2S6_bit at CLC7SEL1.B6;
    const register unsigned short int LC7D2S7 = 7;
    sbit  LC7D2S7_bit at CLC7SEL1.B7;

sfr unsigned short volatile CLC7SEL2         absolute 0xE67;
    const register unsigned short int LC7D3S0 = 0;
    sbit  LC7D3S0_bit at CLC7SEL2.B0;
    const register unsigned short int LC7D3S1 = 1;
    sbit  LC7D3S1_bit at CLC7SEL2.B1;
    const register unsigned short int LC7D3S2 = 2;
    sbit  LC7D3S2_bit at CLC7SEL2.B2;
    const register unsigned short int LC7D3S3 = 3;
    sbit  LC7D3S3_bit at CLC7SEL2.B3;
    const register unsigned short int LC7D3S4 = 4;
    sbit  LC7D3S4_bit at CLC7SEL2.B4;
    const register unsigned short int LC7D3S5 = 5;
    sbit  LC7D3S5_bit at CLC7SEL2.B5;
    const register unsigned short int LC7D3S6 = 6;
    sbit  LC7D3S6_bit at CLC7SEL2.B6;
    const register unsigned short int LC7D3S7 = 7;
    sbit  LC7D3S7_bit at CLC7SEL2.B7;

sfr unsigned short volatile CLC7SEL3         absolute 0xE68;
    const register unsigned short int LC7D4S0 = 0;
    sbit  LC7D4S0_bit at CLC7SEL3.B0;
    const register unsigned short int LC7D4S1 = 1;
    sbit  LC7D4S1_bit at CLC7SEL3.B1;
    const register unsigned short int LC7D4S2 = 2;
    sbit  LC7D4S2_bit at CLC7SEL3.B2;
    const register unsigned short int LC7D4S3 = 3;
    sbit  LC7D4S3_bit at CLC7SEL3.B3;
    const register unsigned short int LC7D4S4 = 4;
    sbit  LC7D4S4_bit at CLC7SEL3.B4;
    const register unsigned short int LC7D4S5 = 5;
    sbit  LC7D4S5_bit at CLC7SEL3.B5;
    const register unsigned short int LC7D4S6 = 6;
    sbit  LC7D4S6_bit at CLC7SEL3.B6;
    const register unsigned short int LC7D4S7 = 7;
    sbit  LC7D4S7_bit at CLC7SEL3.B7;

sfr unsigned short volatile CLC7GLS0         absolute 0xE69;
    const register unsigned short int LC7G1D1N = 0;
    sbit  LC7G1D1N_bit at CLC7GLS0.B0;
    const register unsigned short int LC7G1D1T = 1;
    sbit  LC7G1D1T_bit at CLC7GLS0.B1;
    const register unsigned short int LC7G1D2N = 2;
    sbit  LC7G1D2N_bit at CLC7GLS0.B2;
    const register unsigned short int LC7G1D2T = 3;
    sbit  LC7G1D2T_bit at CLC7GLS0.B3;
    const register unsigned short int LC7G1D3N = 4;
    sbit  LC7G1D3N_bit at CLC7GLS0.B4;
    const register unsigned short int LC7G1D3T = 5;
    sbit  LC7G1D3T_bit at CLC7GLS0.B5;
    const register unsigned short int LC7G1D4N = 6;
    sbit  LC7G1D4N_bit at CLC7GLS0.B6;
    const register unsigned short int LC7G1D4T = 7;
    sbit  LC7G1D4T_bit at CLC7GLS0.B7;

sfr unsigned short volatile CLC7GLS1         absolute 0xE6A;
    const register unsigned short int LC7G2D1N = 0;
    sbit  LC7G2D1N_bit at CLC7GLS1.B0;
    const register unsigned short int LC7G2D1T = 1;
    sbit  LC7G2D1T_bit at CLC7GLS1.B1;
    const register unsigned short int LC7G2D2N = 2;
    sbit  LC7G2D2N_bit at CLC7GLS1.B2;
    const register unsigned short int LC7G2D2T = 3;
    sbit  LC7G2D2T_bit at CLC7GLS1.B3;
    const register unsigned short int LC7G2D3N = 4;
    sbit  LC7G2D3N_bit at CLC7GLS1.B4;
    const register unsigned short int LC7G2D3T = 5;
    sbit  LC7G2D3T_bit at CLC7GLS1.B5;
    const register unsigned short int LC7G2D4N = 6;
    sbit  LC7G2D4N_bit at CLC7GLS1.B6;
    const register unsigned short int LC7G2D4T = 7;
    sbit  LC7G2D4T_bit at CLC7GLS1.B7;

sfr unsigned short volatile CLC7GLS2         absolute 0xE6B;
    const register unsigned short int LC7G3D1N = 0;
    sbit  LC7G3D1N_bit at CLC7GLS2.B0;
    const register unsigned short int LC7G3D1T = 1;
    sbit  LC7G3D1T_bit at CLC7GLS2.B1;
    const register unsigned short int LC7G3D2N = 2;
    sbit  LC7G3D2N_bit at CLC7GLS2.B2;
    const register unsigned short int LC7G3D2T = 3;
    sbit  LC7G3D2T_bit at CLC7GLS2.B3;
    const register unsigned short int LC7G3D3N = 4;
    sbit  LC7G3D3N_bit at CLC7GLS2.B4;
    const register unsigned short int LC7G3D3T = 5;
    sbit  LC7G3D3T_bit at CLC7GLS2.B5;
    const register unsigned short int LC7G3D4N = 6;
    sbit  LC7G3D4N_bit at CLC7GLS2.B6;
    const register unsigned short int LC7G3D4T = 7;
    sbit  LC7G3D4T_bit at CLC7GLS2.B7;

sfr unsigned short volatile CLC7GLS3         absolute 0xE6C;
    const register unsigned short int LC7G4D1N = 0;
    sbit  LC7G4D1N_bit at CLC7GLS3.B0;
    const register unsigned short int LC7G4D1T = 1;
    sbit  LC7G4D1T_bit at CLC7GLS3.B1;
    const register unsigned short int LC7G4D2N = 2;
    sbit  LC7G4D2N_bit at CLC7GLS3.B2;
    const register unsigned short int LC7G4D2T = 3;
    sbit  LC7G4D2T_bit at CLC7GLS3.B3;
    const register unsigned short int LC7G4D3N = 4;
    sbit  LC7G4D3N_bit at CLC7GLS3.B4;
    const register unsigned short int LC7G4D3T = 5;
    sbit  LC7G4D3T_bit at CLC7GLS3.B5;
    const register unsigned short int LC7G4D4N = 6;
    sbit  LC7G4D4N_bit at CLC7GLS3.B6;
    const register unsigned short int LC7G4D4T = 7;
    sbit  LC7G4D4T_bit at CLC7GLS3.B7;

sfr unsigned short volatile CLC8CON          absolute 0xE6D;
    const register unsigned short int LC8MODE0 = 0;
    sbit  LC8MODE0_bit at CLC8CON.B0;
    const register unsigned short int LC8MODE1 = 1;
    sbit  LC8MODE1_bit at CLC8CON.B1;
    const register unsigned short int LC8MODE2 = 2;
    sbit  LC8MODE2_bit at CLC8CON.B2;
    const register unsigned short int LC8INTN = 3;
    sbit  LC8INTN_bit at CLC8CON.B3;
    const register unsigned short int LC8INTP = 4;
    sbit  LC8INTP_bit at CLC8CON.B4;
    const register unsigned short int LC8OUT = 5;
    sbit  LC8OUT_bit at CLC8CON.B5;
    const register unsigned short int LC8EN = 7;
    sbit  LC8EN_bit at CLC8CON.B7;

sfr unsigned short volatile CLC8POL          absolute 0xE6E;
    const register unsigned short int LC8G1POL = 0;
    sbit  LC8G1POL_bit at CLC8POL.B0;
    const register unsigned short int LC8G2POL = 1;
    sbit  LC8G2POL_bit at CLC8POL.B1;
    const register unsigned short int LC8G3POL = 2;
    sbit  LC8G3POL_bit at CLC8POL.B2;
    const register unsigned short int LC8G4POL = 3;
    sbit  LC8G4POL_bit at CLC8POL.B3;
    const register unsigned short int LC8POL = 7;
    sbit  LC8POL_bit at CLC8POL.B7;

sfr unsigned short volatile CLC8SEL0         absolute 0xE6F;
    const register unsigned short int LC8D1S0 = 0;
    sbit  LC8D1S0_bit at CLC8SEL0.B0;
    const register unsigned short int LC8D1S1 = 1;
    sbit  LC8D1S1_bit at CLC8SEL0.B1;
    const register unsigned short int LC8D1S2 = 2;
    sbit  LC8D1S2_bit at CLC8SEL0.B2;
    const register unsigned short int LC8D1S3 = 3;
    sbit  LC8D1S3_bit at CLC8SEL0.B3;
    const register unsigned short int LC8D1S4 = 4;
    sbit  LC8D1S4_bit at CLC8SEL0.B4;
    const register unsigned short int LC8D1S5 = 5;
    sbit  LC8D1S5_bit at CLC8SEL0.B5;
    const register unsigned short int LC8D1S6 = 6;
    sbit  LC8D1S6_bit at CLC8SEL0.B6;
    const register unsigned short int LC8D1S7 = 7;
    sbit  LC8D1S7_bit at CLC8SEL0.B7;

sfr unsigned short volatile CLC8SEL1         absolute 0xE70;
    const register unsigned short int LC8D2S0 = 0;
    sbit  LC8D2S0_bit at CLC8SEL1.B0;
    const register unsigned short int LC8D2S1 = 1;
    sbit  LC8D2S1_bit at CLC8SEL1.B1;
    const register unsigned short int LC8D2S2 = 2;
    sbit  LC8D2S2_bit at CLC8SEL1.B2;
    const register unsigned short int LC8D2S3 = 3;
    sbit  LC8D2S3_bit at CLC8SEL1.B3;
    const register unsigned short int LC8D2S4 = 4;
    sbit  LC8D2S4_bit at CLC8SEL1.B4;
    const register unsigned short int LC8D2S5 = 5;
    sbit  LC8D2S5_bit at CLC8SEL1.B5;
    const register unsigned short int LC8D2S6 = 6;
    sbit  LC8D2S6_bit at CLC8SEL1.B6;
    const register unsigned short int LC8D2S7 = 7;
    sbit  LC8D2S7_bit at CLC8SEL1.B7;

sfr unsigned short volatile CLC8SEL2         absolute 0xE71;
    const register unsigned short int LC8D3S0 = 0;
    sbit  LC8D3S0_bit at CLC8SEL2.B0;
    const register unsigned short int LC8D3S1 = 1;
    sbit  LC8D3S1_bit at CLC8SEL2.B1;
    const register unsigned short int LC8D3S2 = 2;
    sbit  LC8D3S2_bit at CLC8SEL2.B2;
    const register unsigned short int LC8D3S3 = 3;
    sbit  LC8D3S3_bit at CLC8SEL2.B3;
    const register unsigned short int LC8D3S4 = 4;
    sbit  LC8D3S4_bit at CLC8SEL2.B4;
    const register unsigned short int LC8D3S5 = 5;
    sbit  LC8D3S5_bit at CLC8SEL2.B5;
    const register unsigned short int LC8D3S6 = 6;
    sbit  LC8D3S6_bit at CLC8SEL2.B6;
    const register unsigned short int LC8D3S7 = 7;
    sbit  LC8D3S7_bit at CLC8SEL2.B7;

sfr unsigned short volatile CLC8SEL3         absolute 0xE72;
    const register unsigned short int LC8D4S0 = 0;
    sbit  LC8D4S0_bit at CLC8SEL3.B0;
    const register unsigned short int LC8D4S1 = 1;
    sbit  LC8D4S1_bit at CLC8SEL3.B1;
    const register unsigned short int LC8D4S2 = 2;
    sbit  LC8D4S2_bit at CLC8SEL3.B2;
    const register unsigned short int LC8D4S3 = 3;
    sbit  LC8D4S3_bit at CLC8SEL3.B3;
    const register unsigned short int LC8D4S4 = 4;
    sbit  LC8D4S4_bit at CLC8SEL3.B4;
    const register unsigned short int LC8D4S5 = 5;
    sbit  LC8D4S5_bit at CLC8SEL3.B5;
    const register unsigned short int LC8D4S6 = 6;
    sbit  LC8D4S6_bit at CLC8SEL3.B6;
    const register unsigned short int LC8D4S7 = 7;
    sbit  LC8D4S7_bit at CLC8SEL3.B7;

sfr unsigned short volatile CLC8GLS0         absolute 0xE73;
    const register unsigned short int LC8G1D1N = 0;
    sbit  LC8G1D1N_bit at CLC8GLS0.B0;
    const register unsigned short int LC8G1D1T = 1;
    sbit  LC8G1D1T_bit at CLC8GLS0.B1;
    const register unsigned short int LC8G1D2N = 2;
    sbit  LC8G1D2N_bit at CLC8GLS0.B2;
    const register unsigned short int LC8G1D2T = 3;
    sbit  LC8G1D2T_bit at CLC8GLS0.B3;
    const register unsigned short int LC8G1D3N = 4;
    sbit  LC8G1D3N_bit at CLC8GLS0.B4;
    const register unsigned short int LC8G1D3T = 5;
    sbit  LC8G1D3T_bit at CLC8GLS0.B5;
    const register unsigned short int LC8G1D4N = 6;
    sbit  LC8G1D4N_bit at CLC8GLS0.B6;
    const register unsigned short int LC8G1D4T = 7;
    sbit  LC8G1D4T_bit at CLC8GLS0.B7;

sfr unsigned short volatile CLC8GLS1         absolute 0xE74;
    const register unsigned short int LC8G2D1N = 0;
    sbit  LC8G2D1N_bit at CLC8GLS1.B0;
    const register unsigned short int LC8G2D1T = 1;
    sbit  LC8G2D1T_bit at CLC8GLS1.B1;
    const register unsigned short int LC8G2D2N = 2;
    sbit  LC8G2D2N_bit at CLC8GLS1.B2;
    const register unsigned short int LC8G2D2T = 3;
    sbit  LC8G2D2T_bit at CLC8GLS1.B3;
    const register unsigned short int LC8G2D3N = 4;
    sbit  LC8G2D3N_bit at CLC8GLS1.B4;
    const register unsigned short int LC8G2D3T = 5;
    sbit  LC8G2D3T_bit at CLC8GLS1.B5;
    const register unsigned short int LC8G2D4N = 6;
    sbit  LC8G2D4N_bit at CLC8GLS1.B6;
    const register unsigned short int LC8G2D4T = 7;
    sbit  LC8G2D4T_bit at CLC8GLS1.B7;

sfr unsigned short volatile CLC8GLS2         absolute 0xE75;
    const register unsigned short int LC8G3D1N = 0;
    sbit  LC8G3D1N_bit at CLC8GLS2.B0;
    const register unsigned short int LC8G3D1T = 1;
    sbit  LC8G3D1T_bit at CLC8GLS2.B1;
    const register unsigned short int LC8G3D2N = 2;
    sbit  LC8G3D2N_bit at CLC8GLS2.B2;
    const register unsigned short int LC8G3D2T = 3;
    sbit  LC8G3D2T_bit at CLC8GLS2.B3;
    const register unsigned short int LC8G3D3N = 4;
    sbit  LC8G3D3N_bit at CLC8GLS2.B4;
    const register unsigned short int LC8G3D3T = 5;
    sbit  LC8G3D3T_bit at CLC8GLS2.B5;
    const register unsigned short int LC8G3D4N = 6;
    sbit  LC8G3D4N_bit at CLC8GLS2.B6;
    const register unsigned short int LC8G3D4T = 7;
    sbit  LC8G3D4T_bit at CLC8GLS2.B7;

sfr unsigned short volatile CLC8GLS3         absolute 0xE76;
    const register unsigned short int LC8G4D1N = 0;
    sbit  LC8G4D1N_bit at CLC8GLS3.B0;
    const register unsigned short int LC8G4D1T = 1;
    sbit  LC8G4D1T_bit at CLC8GLS3.B1;
    const register unsigned short int LC8G4D2N = 2;
    sbit  LC8G4D2N_bit at CLC8GLS3.B2;
    const register unsigned short int LC8G4D2T = 3;
    sbit  LC8G4D2T_bit at CLC8GLS3.B3;
    const register unsigned short int LC8G4D3N = 4;
    sbit  LC8G4D3N_bit at CLC8GLS3.B4;
    const register unsigned short int LC8G4D3T = 5;
    sbit  LC8G4D3T_bit at CLC8GLS3.B5;
    const register unsigned short int LC8G4D4N = 6;
    sbit  LC8G4D4N_bit at CLC8GLS3.B6;
    const register unsigned short int LC8G4D4T = 7;
    sbit  LC8G4D4T_bit at CLC8GLS3.B7;

sfr unsigned short volatile CLCDATA          absolute 0xE77;
    const register unsigned short int MCL1OUT = 0;
    sbit  MCL1OUT_bit at CLCDATA.B0;
    ...
    const register unsigned short int MLC5OUT = 4;
    sbit  MLC5OUT_bit at CLCDATA.B4;
    const register unsigned short int MLC6OUT = 5;
    sbit  MLC6OUT_bit at CLCDATA.B5;
    const register unsigned short int MLC7OUT = 6;
    sbit  MLC7OUT_bit at CLCDATA.B6;
    const register unsigned short int MLC8OUT = 7;
    sbit  MLC8OUT_bit at CLCDATA.B7;

sfr unsigned short volatile RX2PPS           absolute 0xE88;
...
sfr unsigned short volatile RXDT2PPS         absolute 0xE88;
sfr unsigned short volatile CK2PPS           absolute 0xE89;
    const register unsigned short int CK2PPS0 = 0;
    sbit  CK2PPS0_bit at CK2PPS.B0;
    const register unsigned short int CK2PPS1 = 1;
    sbit  CK2PPS1_bit at CK2PPS.B1;
    const register unsigned short int CK2PPS2 = 2;
    sbit  CK2PPS2_bit at CK2PPS.B2;
    const register unsigned short int CK2PPS3 = 3;
    sbit  CK2PPS3_bit at CK2PPS.B3;
    const register unsigned short int CK2PPS4 = 4;
    sbit  CK2PPS4_bit at CK2PPS.B4;

sfr unsigned short volatile TXCK2PPS         absolute 0xE89;
sfr unsigned short volatile SSP2CLKPPS       absolute 0xE8A;
...
sfr unsigned short volatile SSP2DATPPS       absolute 0xE8B;
...
sfr unsigned short volatile SSP2SSPPS        absolute 0xE8C;
...
sfr unsigned short volatile SSP2BUF          absolute 0xE8D;
sfr unsigned short volatile SSP2ADD          absolute 0xE8E;
...
sfr unsigned short volatile SSP2MSK          absolute 0xE8F;
sfr unsigned short volatile SSP2STAT         absolute 0xE90;
...
sfr unsigned short volatile SSP2CON1         absolute 0xE91;
...
sfr unsigned short volatile SSP2CON2         absolute 0xE92;
...
sfr unsigned short volatile SSP2CON3         absolute 0xE93;
sfr unsigned short volatile RC2REG           absolute 0xE94;
sfr unsigned short volatile RCREG2           absolute 0xE94;
sfr unsigned short volatile TX2REG           absolute 0xE95;
sfr unsigned short volatile TXREG2           absolute 0xE95;
sfr unsigned int   volatile SP2BRG           absolute 0xE96;
sfr unsigned short volatile SP2BRGL          absolute 0xE96;
sfr unsigned int            SPBRG2           absolute 0xE96;
sfr unsigned short volatile SP2BRGH          absolute 0xE97;
sfr unsigned short          SPBRGH2          absolute 0xE97;
sfr unsigned short volatile RC2STA           absolute 0xE98;
sfr unsigned short volatile RCSTA2           absolute 0xE98;
sfr unsigned short volatile TX2STA           absolute 0xE99;
sfr unsigned short volatile TXSTA2           absolute 0xE99;
sfr unsigned short volatile BAUD2CON         absolute 0xE9A;
sfr unsigned short          BAUDCON2         absolute 0xE9A;
sfr unsigned short volatile PPSLOCK          absolute 0xE9B;
    const register unsigned short int PPSLOCKED = 0;
    sbit  PPSLOCKED_bit at PPSLOCK.B0;

sfr unsigned short volatile INT0PPS          absolute 0xE9C;
...
sfr unsigned short volatile INT1PPS          absolute 0xE9D;
...
sfr unsigned short volatile INT2PPS          absolute 0xE9E;
...
sfr unsigned short volatile T0CKIPPS         absolute 0xE9F;
...
sfr unsigned short volatile T1CKIPPS         absolute 0xEA0;
...
sfr unsigned short volatile T1GPPS           absolute 0xEA1;
...
sfr unsigned short volatile T3CKIPPS         absolute 0xEA2;
...
sfr unsigned short volatile T3GPPS           absolute 0xEA3;
...
sfr unsigned short volatile T5CKIPPS         absolute 0xEA4;
...
sfr unsigned short volatile T5GPPS           absolute 0xEA5;
...
sfr unsigned short volatile T2INPPS          absolute 0xEA6;
...
sfr unsigned short volatile T4INPPS          absolute 0xEA7;
...
sfr unsigned short volatile T6INPPS          absolute 0xEA8;
...
sfr unsigned short volatile ADACTPPS         absolute 0xEA9;
...
sfr unsigned short volatile CCP1PPS          absolute 0xEAA;
...
sfr unsigned short volatile CCP2PPS          absolute 0xEAB;
...
sfr unsigned short volatile CWG1PPS          absolute 0xEAC;
...
sfr unsigned short volatile CWGPPS           absolute 0xEAC;
sfr unsigned short volatile MDCARLPPS        absolute 0xEAD;
...
sfr unsigned short volatile MDCARHPPS        absolute 0xEAE;
...
sfr unsigned short volatile MDSRCPPS         absolute 0xEAF;
...
sfr unsigned short volatile RX1PPS           absolute 0xEB0;
    const register unsigned short int RXPPS0 = 0;
    sbit  RXPPS0_bit at RX1PPS.B0;
    const register unsigned short int RXPPS1 = 1;
    sbit  RXPPS1_bit at RX1PPS.B1;
    const register unsigned short int RXPPS2 = 2;
    sbit  RXPPS2_bit at RX1PPS.B2;
    const register unsigned short int RXPPS3 = 3;
    sbit  RXPPS3_bit at RX1PPS.B3;
    const register unsigned short int RXPPS4 = 4;
    sbit  RXPPS4_bit at RX1PPS.B4;

sfr unsigned short volatile RXPPS            absolute 0xEB0;
sfr unsigned short volatile CK1PPS           absolute 0xEB1;
    const register unsigned short int TXPPS0 = 0;
    sbit  TXPPS0_bit at CK1PPS.B0;
    const register unsigned short int TXPPS1 = 1;
    sbit  TXPPS1_bit at CK1PPS.B1;
    const register unsigned short int TXPPS2 = 2;
    sbit  TXPPS2_bit at CK1PPS.B2;
    const register unsigned short int TXPPS3 = 3;
    sbit  TXPPS3_bit at CK1PPS.B3;
    const register unsigned short int TXPPS4 = 4;
    sbit  TXPPS4_bit at CK1PPS.B4;

sfr unsigned short volatile TXPPS            absolute 0xEB1;
sfr unsigned short volatile SSP1CLKPPS       absolute 0xEB2;
    ...
    sbit  SSPCLKPPS0_bit at SSP1CLKPPS.B0;
    const register unsigned short int SSPCLKPPS1 = 1;
    sbit  SSPCLKPPS1_bit at SSP1CLKPPS.B1;
    const register unsigned short int SSPCLKPPS2 = 2;
    sbit  SSPCLKPPS2_bit at SSP1CLKPPS.B2;
    const register unsigned short int SSPCLKPPS3 = 3;
    sbit  SSPCLKPPS3_bit at SSP1CLKPPS.B3;
    const register unsigned short int SSPCLKPPS4 = 4;
    sbit  SSPCLKPPS4_bit at SSP1CLKPPS.B4;

sfr unsigned short volatile SSPCLKPPS        absolute 0xEB2;
sfr unsigned short volatile SSP1DATPPS       absolute 0xEB3;
    ...
    sbit  SSPDATPPS0_bit at SSP1DATPPS.B0;
    const register unsigned short int SSPDATPPS1 = 1;
    sbit  SSPDATPPS1_bit at SSP1DATPPS.B1;
    const register unsigned short int SSPDATPPS2 = 2;
    sbit  SSPDATPPS2_bit at SSP1DATPPS.B2;
    const register unsigned short int SSPDATPPS3 = 3;
    sbit  SSPDATPPS3_bit at SSP1DATPPS.B3;
    const register unsigned short int SSPDATPPS4 = 4;
    sbit  SSPDATPPS4_bit at SSP1DATPPS.B4;

sfr unsigned short volatile SSPDATPPS        absolute 0xEB3;
sfr unsigned short volatile SSP1SSPPS        absolute 0xEB4;
    ...
    sbit  SSPSSPPS0_bit at SSP1SSPPS.B0;
    const register unsigned short int SSPSSPPS1 = 1;
    sbit  SSPSSPPS1_bit at SSP1SSPPS.B1;
    const register unsigned short int SSPSSPPS2 = 2;
    sbit  SSPSSPPS2_bit at SSP1SSPPS.B2;
    const register unsigned short int SSPSSPPS3 = 3;
    sbit  SSPSSPPS3_bit at SSP1SSPPS.B3;
    const register unsigned short int SSPSSPPS4 = 4;
    sbit  SSPSSPPS4_bit at SSP1SSPPS.B4;

sfr unsigned short volatile SSPSSPPS         absolute 0xEB4;
sfr unsigned short volatile IPR0             absolute 0xEB5;
...
sfr unsigned short volatile IPR1             absolute 0xEB6;
...
sfr unsigned short volatile IPR2             absolute 0xEB7;
...
sfr unsigned short volatile IPR3             absolute 0xEB8;
    ...
    const register unsigned short int BCLIP = 1;
    sbit  BCLIP_bit at IPR3.B1;
    const register unsigned short int RCIP = 5;
    sbit  RCIP_bit at IPR3.B5;
    const register unsigned short int SSPIP = 0;
    sbit  SSPIP_bit at IPR3.B0;
    const register unsigned short int TXIP = 4;
    sbit  TXIP_bit at IPR3.B4;

sfr unsigned short volatile IPR4             absolute 0xEB9;
...
sfr unsigned short volatile IPR5             absolute 0xEBA;
    ...
    const register unsigned short int CLC1IP = 4;
    sbit  CLC1IP_bit at IPR5.B4;
    const register unsigned short int CLC2IP = 5;
    sbit  CLC2IP_bit at IPR5.B5;
    const register unsigned short int CLC3IP = 6;
    sbit  CLC3IP_bit at IPR5.B6;
    const register unsigned short int CLC4IP = 7;
    sbit  CLC4IP_bit at IPR5.B7;

sfr unsigned short volatile IPR6             absolute 0xEBB;
    ...
    const register unsigned short int CLC5IP = 4;
    sbit  CLC5IP_bit at IPR6.B4;
    const register unsigned short int CLC6IP = 5;
    sbit  CLC6IP_bit at IPR6.B5;
    const register unsigned short int CLC7IP = 6;
    sbit  CLC7IP_bit at IPR6.B6;
    const register unsigned short int CLC8IP = 7;
    sbit  CLC8IP_bit at IPR6.B7;

sfr unsigned short volatile IPR7             absolute 0xEBC;
...
sfr unsigned short volatile PIE0             absolute 0xEBD;
...
sfr unsigned short volatile PIE1             absolute 0xEBE;
...
sfr unsigned short volatile PIE2             absolute 0xEBF;
...
sfr unsigned short volatile PIE3             absolute 0xEC0;
    ...
    sbit  BCLIE_bit at PIE3.B1;
    const register unsigned short int RCIE = 5;
    sbit  RCIE_bit at PIE3.B5;
    const register unsigned short int SSPIE = 0;
    sbit  SSPIE_bit at PIE3.B0;
    const register unsigned short int TXIE = 4;
    sbit  TXIE_bit at PIE3.B4;

sfr unsigned short volatile PIE4             absolute 0xEC1;
...
sfr unsigned short volatile PIE5             absolute 0xEC2;
...
sfr unsigned short volatile PIE6             absolute 0xEC3;
    ...
    const register unsigned short int CLC5IE = 4;
    sbit  CLC5IE_bit at PIE6.B4;
    const register unsigned short int CLC6IE = 5;
    sbit  CLC6IE_bit at PIE6.B5;
    const register unsigned short int CLC7IE = 6;
    sbit  CLC7IE_bit at PIE6.B6;
    const register unsigned short int CLC8IE = 7;
    sbit  CLC8IE_bit at PIE6.B7;

sfr unsigned short volatile PIE7             absolute 0xEC4;
...
sfr unsigned short volatile PIR0             absolute 0xEC5;
...
sfr unsigned short volatile PIR1             absolute 0xEC6;
...
sfr unsigned short volatile PIR2             absolute 0xEC7;
...
sfr unsigned short volatile PIR3             absolute 0xEC8;
    ...
    const register unsigned short int BCLIF = 1;
    sbit  BCLIF_bit at PIR3.B1;
    const register unsigned short int RCIF = 5;
    sbit  RCIF_bit at PIR3.B5;
    const register unsigned short int SSPIF = 0;
    sbit  SSPIF_bit at PIR3.B0;
    const register unsigned short int TXIF = 4;
    sbit  TXIF_bit at PIR3.B4;

sfr unsigned short volatile PIR4             absolute 0xEC9;
...
sfr unsigned short volatile PIR5             absolute 0xECA;
...
sfr unsigned short volatile PIR6             absolute 0xECB;
    ...
    const register unsigned short int CLC5IF = 4;
    sbit  CLC5IF_bit at PIR6.B4;
    const register unsigned short int CLC6IF = 5;
    sbit  CLC6IF_bit at PIR6.B5;
    const register unsigned short int CLC7IF = 6;
    sbit  CLC7IF_bit at PIR6.B6;
    const register unsigned short int CLC8IF = 7;
    sbit  CLC8IF_bit at PIR6.B7;

sfr unsigned short volatile PIR7             absolute 0xECC;
...
sfr unsigned short volatile WDTCON0          absolute 0xECD;
...
sfr unsigned short volatile WDTCON1          absolute 0xECE;
...
sfr unsigned short volatile WDTPSL           absolute 0xECF;
...
sfr unsigned short volatile WDTPSH           absolute 0xED0;
...
sfr unsigned short volatile WDTTMR           absolute 0xED1;
...
sfr unsigned short volatile CPUDOZE          absolute 0xED2;
...
sfr unsigned short volatile OSCCON1          absolute 0xED3;
...
sfr unsigned short volatile OSCCON2          absolute 0xED4;
...
sfr unsigned short volatile OSCCON3          absolute 0xED5;
...
sfr unsigned short volatile OSCSTAT          absolute 0xED6;
...
sfr unsigned short volatile OSCSTAT1         absolute 0xED6;
sfr unsigned short volatile OSCEN            absolute 0xED7;
...
sfr unsigned short volatile OSCTUNE          absolute 0xED8;
...
sfr unsigned short volatile OSCFRQ           absolute 0xED9;
...
sfr unsigned short volatile OSCFREQ          absolute 0xED9;
sfr unsigned short volatile VREGCON          absolute 0xEDA;
...
sfr unsigned short volatile BORCON           absolute 0xEDB;
...
sfr unsigned short volatile PMD0             absolute 0xEDC;
...
sfr unsigned short volatile PMD1             absolute 0xEDD;
...
sfr unsigned short volatile PMD2             absolute 0xEDE;
...
sfr unsigned short volatile PMD3             absolute 0xEDF;
    ...
    sbit  CLC5MD_bit at PMD3.B4;
    const register unsigned short int CLC6MD = 5;
    sbit  CLC6MD_bit at PMD3.B5;
    const register unsigned short int CLC7MD = 6;
    sbit  CLC7MD_bit at PMD3.B6;
    const register unsigned short int CLC8MD = 7;
    sbit  CLC8MD_bit at PMD3.B7;

sfr unsigned short volatile PMD4             absolute 0xEE0;
...
sfr unsigned short volatile PMD5             absolute 0xEE1;
    const register unsigned short int DSMMD = 0;
    sbit  DSMMD_bit at PMD5.B0;
    const register unsigned short int CLC1MD = 4;
    sbit  CLC1MD_bit at PMD5.B4;
    const register unsigned short int CLC2MD = 5;
    sbit  CLC2MD_bit at PMD5.B5;
    const register unsigned short int CLC3MD = 6;
    sbit  CLC3MD_bit at PMD5.B6;
    const register unsigned short int CLC4MD = 7;
    sbit  CLC4MD_bit at PMD5.B7;

sfr unsigned short volatile RA0PPS           absolute 0xEE2;
...
sfr unsigned short volatile RA1PPS           absolute 0xEE3;
...
sfr unsigned short volatile RA2PPS           absolute 0xEE4;
...
sfr unsigned short volatile RA3PPS           absolute 0xEE5;
...
sfr unsigned short volatile RA4PPS           absolute 0xEE6;
...
sfr unsigned short volatile RA5PPS           absolute 0xEE7;
...
sfr unsigned short volatile RA6PPS           absolute 0xEE8;
...
sfr unsigned short volatile RA7PPS           absolute 0xEE9;
...
sfr unsigned short volatile RB0PPS           absolute 0xEEA;
...
sfr unsigned short volatile RB1PPS           absolute 0xEEB;
...
sfr unsigned short volatile RB2PPS           absolute 0xEEC;
...
sfr unsigned short volatile RB3PPS           absolute 0xEED;
...
sfr unsigned short volatile RB4PPS           absolute 0xEEE;
...
sfr unsigned short volatile RB5PPS           absolute 0xEEF;
...
sfr unsigned short volatile RB6PPS           absolute 0xEF0;
...
sfr unsigned short volatile RB7PPS           absolute 0xEF1;
...
sfr unsigned short volatile RC0PPS           absolute 0xEF2;
...
sfr unsigned short volatile RC1PPS           absolute 0xEF3;
...
sfr unsigned short volatile RC2PPS           absolute 0xEF4;
...
sfr unsigned short volatile RC3PPS           absolute 0xEF5;
...
sfr unsigned short volatile RC4PPS           absolute 0xEF6;
...
sfr unsigned short volatile RC5PPS           absolute 0xEF7;
...
sfr unsigned short volatile RC6PPS           absolute 0xEF8;
...
sfr unsigned short volatile RC7PPS           absolute 0xEF9;
...
sfr unsigned short volatile RD0PPS           absolute 0xEFA;
...
sfr unsigned short volatile RD1PPS           absolute 0xEFB;
...
sfr unsigned short volatile RD2PPS           absolute 0xEFC;
...
sfr unsigned short volatile RD3PPS           absolute 0xEFD;
...
sfr unsigned short volatile RD4PPS           absolute 0xEFE;
...
sfr unsigned short volatile RD5PPS           absolute 0xEFF;
...
sfr unsigned short volatile RD6PPS           absolute 0xF00;
...
sfr unsigned short volatile RD7PPS           absolute 0xF01;
...
sfr unsigned short volatile RE0PPS           absolute 0xF02;
...
sfr unsigned short volatile RE1PPS           absolute 0xF03;
...
sfr unsigned short volatile RE2PPS           absolute 0xF04;
...
sfr unsigned short volatile IOCAF            absolute 0xF05;
...
sfr unsigned short volatile IOCAN            absolute 0xF06;
...
sfr unsigned short volatile IOCAP            absolute 0xF07;
...
sfr unsigned short volatile INLVLA           absolute 0xF08;
...
sfr unsigned short volatile SLRCONA          absolute 0xF09;
...
sfr unsigned short volatile ODCONA           absolute 0xF0A;
...
sfr unsigned short          WPUA             absolute 0xF0B;
...
sfr unsigned short volatile ANSELA           absolute 0xF0C;
...
sfr unsigned short volatile IOCBF            absolute 0xF0D;
...
sfr unsigned short volatile IOCBN            absolute 0xF0E;
...
sfr unsigned short volatile IOCBP            absolute 0xF0F;
...
sfr unsigned short volatile INLVLB           absolute 0xF10;
...
sfr unsigned short volatile SLRCONB          absolute 0xF11;
...
sfr unsigned short volatile ODCONB           absolute 0xF12;
...
sfr unsigned short          WPUB             absolute 0xF13;
...
sfr unsigned short volatile ANSELB           absolute 0xF14;
...
sfr unsigned short volatile IOCCF            absolute 0xF15;
...
sfr unsigned short volatile IOCCN            absolute 0xF16;
...
sfr unsigned short volatile IOCCP            absolute 0xF17;
...
sfr unsigned short volatile INLVLC           absolute 0xF18;
...
sfr unsigned short volatile SLRCONC          absolute 0xF19;
...
sfr unsigned short volatile ODCONC           absolute 0xF1A;
...
sfr unsigned short volatile WPUC             absolute 0xF1B;
...
sfr unsigned short volatile ANSELC           absolute 0xF1C;
...
sfr unsigned short volatile INLVLD           absolute 0xF1D;
...
sfr unsigned short volatile SLRCOND          absolute 0xF1E;
...
sfr unsigned short volatile ODCOND           absolute 0xF1F;
...
sfr unsigned short volatile WPUD             absolute 0xF20;
...
sfr unsigned short volatile ANSELD           absolute 0xF21;
...
sfr unsigned short volatile SLRCONE          absolute 0xF26;
...
sfr unsigned short volatile ODCONE           absolute 0xF27;
...
sfr unsigned short volatile WPUE             absolute 0xF28;
...
sfr unsigned short volatile ANSELE           absolute 0xF29;
...
sfr unsigned short volatile HLVDCON0         absolute 0xF2A;
...
sfr unsigned short volatile HLVDCON1         absolute 0xF2B;
...
sfr unsigned short volatile FVRCON           absolute 0xF2C;
...
sfr unsigned short volatile ZCDCON           absolute 0xF2D;
...
sfr unsigned short volatile DAC1CON0         absolute 0xF2E;
...
sfr unsigned short volatile DAC1CON1         absolute 0xF2F;
...
sfr unsigned short volatile CM2CON0          absolute 0xF30;
...
sfr unsigned short volatile CM2CON1          absolute 0xF31;
...
sfr unsigned short volatile CM2NCH           absolute 0xF32;
...
sfr unsigned short volatile CM2PCH           absolute 0xF33;
...
sfr unsigned short volatile CM1CON0          absolute 0xF34;
...
sfr unsigned short volatile CM1CON1          absolute 0xF35;
...
sfr unsigned short volatile CM1NCH           absolute 0xF36;
...
sfr unsigned short volatile CM1PCH           absolute 0xF37;
...
sfr unsigned short volatile CMOUT            absolute 0xF38;
...
sfr unsigned short volatile CLKRCON          absolute 0xF39;
...
sfr unsigned short volatile CLKRCLK          absolute 0xF3A;
...
sfr unsigned short volatile CWG1CLK          absolute 0xF3B;
    const register unsigned short int CS = 0;
    sbit  CS_bit at CWG1CLK.B0;
    const register unsigned short int CWG1CS = 0;
    sbit  CWG1CS_bit at CWG1CLK.B0;

sfr unsigned short volatile CWG1CLKCON       absolute 0xF3B;
sfr unsigned short volatile CWG1ISM          absolute 0xF3C;
...
sfr unsigned short volatile CWG1DBR          absolute 0xF3D;
...
sfr unsigned short volatile CWG1DBF          absolute 0xF3E;
...
sfr unsigned short volatile CWG1CON0         absolute 0xF3F;
...
sfr unsigned short volatile CWG1CON1         absolute 0xF40;
...
sfr unsigned short volatile CWG1AS0          absolute 0xF41;
...
sfr unsigned short volatile CWG1AS1          absolute 0xF42;
...
sfr unsigned short volatile CWG1STR          absolute 0xF43;
...
sfr unsigned short volatile SCANLADRL        absolute 0xF44;
...
sfr unsigned short volatile SCANLADRH        absolute 0xF45;
...
sfr unsigned short volatile SCANLADRU        absolute 0xF46;
...
sfr unsigned short volatile SCANHADRL        absolute 0xF47;
...
sfr unsigned short volatile SCANHADRH        absolute 0xF48;
...
sfr unsigned short volatile SCANHADRU        absolute 0xF49;
...
sfr unsigned short volatile SCANCON0         absolute 0xF4A;
...
sfr unsigned short volatile SCANTRIG         absolute 0xF4B;
...
sfr unsigned short volatile MDCON0           absolute 0xF4C;
...
sfr unsigned short volatile MDCON1           absolute 0xF4D;
...
sfr unsigned short volatile MDSRC            absolute 0xF4E;
...
sfr unsigned short volatile MDCARL           absolute 0xF4F;
...
sfr unsigned short volatile MDCARH           absolute 0xF50;
...
sfr unsigned short volatile ADACT            absolute 0xF51;
...
sfr unsigned short volatile ADCLK            absolute 0xF52;
...
sfr unsigned short volatile ADREF            absolute 0xF53;
...
sfr unsigned short volatile ADCON1           absolute 0xF54;
...
sfr unsigned short volatile ADCON2           absolute 0xF55;
...
sfr unsigned short volatile ADCON3           absolute 0xF56;
...
sfr unsigned short volatile ADACQ            absolute 0xF57;
...
sfr unsigned short volatile ADCAP            absolute 0xF58;
...
sfr unsigned short volatile ADPRE            absolute 0xF59;
...
sfr unsigned short volatile ADPCH            absolute 0xF5A;
...
sfr unsigned short volatile ADCON0           absolute 0xF5B;
...
sfr unsigned int   volatile ADPREV           absolute 0xF5C;
sfr unsigned short volatile ADPREVL          absolute 0xF5C;
...
sfr unsigned short volatile ADPREVH          absolute 0xF5D;
...
sfr unsigned int   volatile ADRES            absolute 0xF5E;
sfr unsigned short volatile ADRESL           absolute 0xF5E;
...
sfr unsigned short volatile ADRESH           absolute 0xF5F;
...
sfr unsigned short volatile ADSTAT           absolute 0xF60;
...
sfr unsigned short volatile ADRPT            absolute 0xF61;
...
sfr unsigned short volatile ADCNT            absolute 0xF62;
...
sfr unsigned int   volatile ADSTPT           absolute 0xF63;
sfr unsigned short volatile ADSTPTL          absolute 0xF63;
...
sfr unsigned short volatile ADSTPTH          absolute 0xF64;
...
sfr unsigned int   volatile ADLTH            absolute 0xF65;
sfr unsigned short volatile ADLTHL           absolute 0xF65;
...
sfr unsigned short volatile ADLTHH           absolute 0xF66;
...
sfr unsigned int   volatile ADUTH            absolute 0xF67;
sfr unsigned short volatile ADUTHL           absolute 0xF67;
...
sfr unsigned short volatile ADUTHH           absolute 0xF68;
...
sfr unsigned int   volatile ADERR            absolute 0xF69;
sfr unsigned short volatile ADERRL           absolute 0xF69;
...
sfr unsigned short volatile ADERRH           absolute 0xF6A;
...
sfr unsigned int   volatile ADACC            absolute 0xF6B;
sfr unsigned short volatile ADACCL           absolute 0xF6B;
...
sfr unsigned short volatile ADACCH           absolute 0xF6C;
...
sfr unsigned int   volatile ADFLTR           absolute 0xF6D;
sfr unsigned short volatile ADFLTRL          absolute 0xF6D;
...
sfr unsigned short volatile ADFLTRH          absolute 0xF6E;
...
sfr unsigned int   volatile CRCDATA          absolute 0xF6F;
sfr unsigned short volatile CRCDATL          absolute 0xF6F;
...
sfr unsigned short volatile CRCDATH          absolute 0xF70;
...
sfr unsigned int   volatile CRCACC           absolute 0xF71;
sfr unsigned short volatile CRCACCL          absolute 0xF71;
...
sfr unsigned short volatile CRCACCH          absolute 0xF72;
...
sfr unsigned int   volatile CRCSHFT          absolute 0xF73;
sfr unsigned short volatile CRCSHIFTL        absolute 0xF73;
...
sfr unsigned short volatile CRCSHIFTH        absolute 0xF74;
...
sfr unsigned int   volatile CRCXOR           absolute 0xF75;
sfr unsigned short volatile CRCXORL          absolute 0xF75;
...
sfr unsigned short volatile CRCXORH          absolute 0xF76;
...
sfr unsigned short volatile CRCCON0          absolute 0xF77;
...
sfr unsigned short volatile CRCCON1          absolute 0xF78;
...
sfr unsigned short volatile NVMADRL          absolute 0xF79;
...
sfr unsigned short volatile NVMADRH          absolute 0xF7A;
...
sfr unsigned short volatile NVMADRU          absolute 0xF7B;
...
sfr unsigned int   volatile NVMDAT           absolute 0xF7C;
sfr unsigned short volatile NVMDATL          absolute 0xF7C;
...
sfr unsigned short volatile NVMDATH          absolute 0xF7D;
...
sfr unsigned short volatile NVMCON0          absolute 0xF7F;
    const register unsigned short int NVMERR = 4;
    sbit  NVMERR_bit at NVMCON0.B4;
    const register unsigned short int NVMEN = 7;
    sbit  NVMEN_bit at NVMCON0.B7;

sfr unsigned short volatile NVMCON1          absolute 0xF80;
    const register unsigned short int RD = 0;
    sbit  RD_bit at NVMCON1.B0;
    const register unsigned short int SECRD = 1;
    sbit  SECRD_bit at NVMCON1.B1;
    const register unsigned short int WR = 4;
    sbit  WR_bit at NVMCON1.B4;
    const register unsigned short int SECWR = 5;
    sbit  SECWR_bit at NVMCON1.B5;
    const register unsigned short int SECER = 6;
    sbit  SECER_bit at NVMCON1.B6;

sfr unsigned short volatile NVMCON2          absolute 0xF81;
sfr unsigned short volatile LATA             absolute 0xF82;
...
sfr unsigned short volatile LATB             absolute 0xF83;
...
sfr unsigned short volatile LATC             absolute 0xF84;
...
sfr unsigned short volatile LATD             absolute 0xF85;
...
sfr unsigned short volatile LATE             absolute 0xF86;
...
sfr unsigned short volatile TRISA            absolute 0xF87;
...
sfr unsigned short volatile DDRA             absolute 0xF87;
sfr unsigned short volatile TRISB            absolute 0xF88;
...
sfr unsigned short volatile DDRB             absolute 0xF88;
sfr unsigned short volatile TRISC            absolute 0xF89;
...
sfr unsigned short volatile DDRC             absolute 0xF89;
sfr unsigned short volatile TRISD            absolute 0xF8A;
...
sfr unsigned short volatile DDRD             absolute 0xF8A;
sfr unsigned short volatile TRISE            absolute 0xF8B;
...
sfr unsigned short volatile DDRE             absolute 0xF8B;
sfr unsigned short volatile PORTA            absolute 0xF8C;
...
sfr unsigned short volatile PORTB            absolute 0xF8D;
...
sfr unsigned short volatile PORTC            absolute 0xF8E;
...
sfr unsigned short volatile PORTD            absolute 0xF8F;
...
sfr unsigned short volatile PORTE            absolute 0xF90;
...
sfr unsigned short volatile BAUDCON          absolute 0xF9E;
sfr unsigned short volatile BAUD1CON         absolute 0xF9E;
sfr unsigned short          BAUDCON1         absolute 0xF9E;
sfr unsigned int   volatile PWM4DC           absolute 0xF9F;
sfr unsigned short volatile PWM4DCL          absolute 0xF9F;
...
sfr unsigned short volatile PWM4DCH          absolute 0xFA0;
...
sfr unsigned short volatile PWM4CON          absolute 0xFA1;
...
sfr unsigned int   volatile PWM3DC           absolute 0xFA2;
sfr unsigned short volatile PWM3DCL          absolute 0xFA2;
...
sfr unsigned short volatile PWM3DCH          absolute 0xFA3;
...
sfr unsigned short          PWM3CON          absolute 0xFA4;
...
sfr unsigned short volatile CCPTMRS          absolute 0xFAD;
...
sfr unsigned short volatile T6TMR            absolute 0xFAE;
sfr unsigned short volatile TMR6             absolute 0xFAE;
sfr unsigned short volatile T6PR             absolute 0xFAF;
sfr unsigned short volatile PR6              absolute 0xFAF;
sfr unsigned short volatile T6CON            absolute 0xFB0;
...
sfr unsigned short volatile T6HLT            absolute 0xFB1;
...
sfr unsigned short volatile T6CLKCON         absolute 0xFB2;
...
sfr unsigned short volatile T6CLK            absolute 0xFB2;
sfr unsigned short volatile T6RST            absolute 0xFB3;
...
sfr unsigned short volatile T4TMR            absolute 0xFB4;
sfr unsigned short volatile TMR4             absolute 0xFB4;
sfr unsigned short volatile T4PR             absolute 0xFB5;
sfr unsigned short volatile PR4              absolute 0xFB5;
sfr unsigned short volatile T4CON            absolute 0xFB6;
...
sfr unsigned short volatile T4HLT            absolute 0xFB7;
...
sfr unsigned short volatile T4CLKCON         absolute 0xFB8;
...
sfr unsigned short volatile T4CLK            absolute 0xFB8;
sfr unsigned short volatile T4RST            absolute 0xFB9;
...
sfr unsigned short volatile T2TMR            absolute 0xFBA;
sfr unsigned short volatile TMR2             absolute 0xFBA;
sfr unsigned short volatile T2PR             absolute 0xFBB;
sfr unsigned short volatile PR2              absolute 0xFBB;
sfr unsigned short volatile T2CON            absolute 0xFBC;
...
sfr unsigned short volatile T2HLT            absolute 0xFBD;
...
sfr unsigned short volatile T2CLKCON         absolute 0xFBE;
...
sfr unsigned short volatile T2CLK            absolute 0xFBE;
sfr unsigned short volatile T2RST            absolute 0xFBF;
...
sfr unsigned int   volatile TMR5             absolute 0xFC0;
sfr unsigned short volatile TMR5L            absolute 0xFC0;
...
sfr unsigned short volatile TMR5H            absolute 0xFC1;
...
sfr unsigned short volatile T5CON            absolute 0xFC2;
...
sfr unsigned short volatile T5GCON           absolute 0xFC3;
...
sfr unsigned short volatile PR5              absolute 0xFC3;
sfr unsigned short volatile T5GATE           absolute 0xFC4;
...
sfr unsigned short volatile TMR5GATE         absolute 0xFC4;
sfr unsigned short volatile T5CLK            absolute 0xFC5;
...
sfr unsigned short volatile TMR5CLK          absolute 0xFC5;
sfr unsigned int   volatile TMR3             absolute 0xFC6;
sfr unsigned short volatile TMR3L            absolute 0xFC6;
...
sfr unsigned short volatile TMR3H            absolute 0xFC7;
...
sfr unsigned short volatile T3CON            absolute 0xFC8;
...
sfr unsigned short volatile T3GCON           absolute 0xFC9;
...
sfr unsigned short volatile PR3              absolute 0xFC9;
sfr unsigned short volatile T3GATE           absolute 0xFCA;
...
sfr unsigned short volatile TMR3GATE         absolute 0xFCA;
sfr unsigned short volatile T3CLK            absolute 0xFCB;
...
sfr unsigned short volatile TMR3CLK          absolute 0xFCB;
sfr unsigned int   volatile TMR1             absolute 0xFCC;
sfr unsigned short volatile TMR1L            absolute 0xFCC;
...
sfr unsigned short volatile TMR1H            absolute 0xFCD;
...
sfr unsigned short volatile T1CON            absolute 0xFCE;
...
sfr unsigned short volatile T1GCON           absolute 0xFCF;
...
sfr unsigned short volatile PR1              absolute 0xFCF;
sfr unsigned short volatile T1GATE           absolute 0xFD0;
...
sfr unsigned short volatile TMR1GATE         absolute 0xFD0;
sfr unsigned short volatile T1CLK            absolute 0xFD1;
...
sfr unsigned short volatile TMR1CLK          absolute 0xFD1;
sfr unsigned short volatile TMR0L            absolute 0xFD2;
...
sfr unsigned short volatile TMR0             absolute 0xFD2;
sfr unsigned short volatile TMR0H            absolute 0xFD3;
...
sfr unsigned short volatile PR0              absolute 0xFD3;
sfr unsigned short volatile T0CON0           absolute 0xFD4;
...
sfr unsigned short volatile T0CON1           absolute 0xFD5;
...
sfr unsigned short volatile PCON1            absolute 0xFD6;
    ...
    const register unsigned short int RCM = 0;
    sbit  RCM_bit at PCON1.B0;
    const register unsigned short int RVREG = 2;
    sbit  RVREG_bit at PCON1.B2;
