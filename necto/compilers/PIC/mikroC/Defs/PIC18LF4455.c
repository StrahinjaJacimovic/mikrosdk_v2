...
sfr unsigned short volatile SPPDATA          absolute 0xF62;
sfr unsigned short volatile SPPCFG           absolute 0xF63;
...
sfr unsigned short volatile SPPEPS           absolute 0xF64;
    const register unsigned short int BUSY = 4;
    sbit  BUSY_bit at SPPEPS.B4;
...
sfr unsigned short volatile SPPCON           absolute 0xF65;
...
sfr unsigned int   volatile UFRM             absolute 0xF66;
sfr unsigned short volatile UFRML            absolute 0xF66;
...
sfr unsigned short volatile UFRMH            absolute 0xF67;
...
sfr unsigned short volatile UIR              absolute 0xF68;
...
sfr unsigned short volatile UIE              absolute 0xF69;
...
sfr unsigned short volatile UEIR             absolute 0xF6A;
...
sfr unsigned short volatile UEIE             absolute 0xF6B;
...
sfr unsigned short volatile UADDR            absolute 0xF6E;
...
sfr unsigned short volatile UCFG             absolute 0xF6F;
    ...
    const register unsigned short int UPP0 = 0;
    sbit  UPP0_bit at UCFG.B0;
    const register unsigned short int UPP1 = 1;
    sbit  UPP1_bit at UCFG.B1;

sfr unsigned short volatile UEP0             absolute 0xF70;
    const register unsigned short int EP0STALL = 0;
    sbit  EP0STALL_bit at UEP0.B0;
    const register unsigned short int EP0INEN = 1;
    sbit  EP0INEN_bit at UEP0.B1;
    const register unsigned short int EP0OUTEN = 2;
    sbit  EP0OUTEN_bit at UEP0.B2;
    const register unsigned short int EP0CONDIS = 3;
    sbit  EP0CONDIS_bit at UEP0.B3;
    const register unsigned short int EP0HSHK = 4;
    sbit  EP0HSHK_bit at UEP0.B4;
    const register unsigned short int EPCONDIS0 = 3;
    sbit  EPCONDIS0_bit at UEP0.B3;
    const register unsigned short int EPHSHK0 = 4;
    sbit  EPHSHK0_bit at UEP0.B4;
    const register unsigned short int EPINEN0 = 1;
    sbit  EPINEN0_bit at UEP0.B1;
    const register unsigned short int EPOUTEN0 = 2;
    sbit  EPOUTEN0_bit at UEP0.B2;
    const register unsigned short int EPSTALL = 0;
    sbit  EPSTALL_bit at UEP0.B0;
    const register unsigned short int EPSTALL0 = 0;
    sbit  EPSTALL0_bit at UEP0.B0;

sfr unsigned short volatile UEP1             absolute 0xF71;
    const register unsigned short int EP1STALL = 0;
    sbit  EP1STALL_bit at UEP1.B0;
    const register unsigned short int EP1INEN = 1;
    sbit  EP1INEN_bit at UEP1.B1;
    const register unsigned short int EP1OUTEN = 2;
    sbit  EP1OUTEN_bit at UEP1.B2;
    const register unsigned short int EP1CONDIS = 3;
    sbit  EP1CONDIS_bit at UEP1.B3;
    const register unsigned short int EP1HSHK = 4;
    sbit  EP1HSHK_bit at UEP1.B4;
    const register unsigned short int EPCONDIS1 = 3;
    sbit  EPCONDIS1_bit at UEP1.B3;
    const register unsigned short int EPHSHK1 = 4;
    sbit  EPHSHK1_bit at UEP1.B4;
    const register unsigned short int EPINEN1 = 1;
    sbit  EPINEN1_bit at UEP1.B1;
    const register unsigned short int EPOUTEN1 = 2;
    sbit  EPOUTEN1_bit at UEP1.B2;
    const register unsigned short int EPSTALL1 = 0;
    sbit  EPSTALL1_bit at UEP1.B0;

sfr unsigned short volatile UEP2             absolute 0xF72;
    const register unsigned short int EP2STALL = 0;
    sbit  EP2STALL_bit at UEP2.B0;
    const register unsigned short int EP2INEN = 1;
    sbit  EP2INEN_bit at UEP2.B1;
    const register unsigned short int EP2OUTEN = 2;
    sbit  EP2OUTEN_bit at UEP2.B2;
    const register unsigned short int EP2CONDIS = 3;
    sbit  EP2CONDIS_bit at UEP2.B3;
    const register unsigned short int EP2HSHK = 4;
    sbit  EP2HSHK_bit at UEP2.B4;
    const register unsigned short int EPCONDIS2 = 3;
    sbit  EPCONDIS2_bit at UEP2.B3;
    const register unsigned short int EPHSHK2 = 4;
    sbit  EPHSHK2_bit at UEP2.B4;
    const register unsigned short int EPINEN2 = 1;
    sbit  EPINEN2_bit at UEP2.B1;
    const register unsigned short int EPOUTEN2 = 2;
    sbit  EPOUTEN2_bit at UEP2.B2;
    const register unsigned short int EPSTALL2 = 0;
    sbit  EPSTALL2_bit at UEP2.B0;

sfr unsigned short volatile UEP3             absolute 0xF73;
    const register unsigned short int EP3STALL = 0;
    sbit  EP3STALL_bit at UEP3.B0;
    const register unsigned short int EP3INEN = 1;
    sbit  EP3INEN_bit at UEP3.B1;
    const register unsigned short int EP3OUTEN = 2;
    sbit  EP3OUTEN_bit at UEP3.B2;
    const register unsigned short int EP3CONDIS = 3;
    sbit  EP3CONDIS_bit at UEP3.B3;
    const register unsigned short int EP3HSHK = 4;
    sbit  EP3HSHK_bit at UEP3.B4;
    const register unsigned short int EPCONDIS3 = 3;
    sbit  EPCONDIS3_bit at UEP3.B3;
    const register unsigned short int EPHSHK3 = 4;
    sbit  EPHSHK3_bit at UEP3.B4;
    const register unsigned short int EPINEN3 = 1;
    sbit  EPINEN3_bit at UEP3.B1;
    const register unsigned short int EPOUTEN3 = 2;
    sbit  EPOUTEN3_bit at UEP3.B2;
    const register unsigned short int EPSTALL3 = 0;
    sbit  EPSTALL3_bit at UEP3.B0;

sfr unsigned short volatile UEP4             absolute 0xF74;
    const register unsigned short int EP4STALL = 0;
    sbit  EP4STALL_bit at UEP4.B0;
    const register unsigned short int EP4INEN = 1;
    sbit  EP4INEN_bit at UEP4.B1;
    const register unsigned short int EP4OUTEN = 2;
    sbit  EP4OUTEN_bit at UEP4.B2;
    const register unsigned short int EP4CONDIS = 3;
    sbit  EP4CONDIS_bit at UEP4.B3;
    const register unsigned short int EP4HSHK = 4;
    sbit  EP4HSHK_bit at UEP4.B4;
    const register unsigned short int EPCONDIS4 = 3;
    sbit  EPCONDIS4_bit at UEP4.B3;
    const register unsigned short int EPHSHK4 = 4;
    sbit  EPHSHK4_bit at UEP4.B4;
    const register unsigned short int EPINEN4 = 1;
    sbit  EPINEN4_bit at UEP4.B1;
    const register unsigned short int EPOUTEN4 = 2;
    sbit  EPOUTEN4_bit at UEP4.B2;
    const register unsigned short int EPSTALL4 = 0;
    sbit  EPSTALL4_bit at UEP4.B0;

sfr unsigned short volatile UEP5             absolute 0xF75;
    const register unsigned short int EP5STALL = 0;
    sbit  EP5STALL_bit at UEP5.B0;
    const register unsigned short int EP5INEN = 1;
    sbit  EP5INEN_bit at UEP5.B1;
    const register unsigned short int EP5OUTEN = 2;
    sbit  EP5OUTEN_bit at UEP5.B2;
    const register unsigned short int EP5CONDIS = 3;
    sbit  EP5CONDIS_bit at UEP5.B3;
    const register unsigned short int EP5HSHK = 4;
    sbit  EP5HSHK_bit at UEP5.B4;
    const register unsigned short int EPCONDIS5 = 3;
    sbit  EPCONDIS5_bit at UEP5.B3;
    const register unsigned short int EPHSHK5 = 4;
    sbit  EPHSHK5_bit at UEP5.B4;
    const register unsigned short int EPINEN5 = 1;
    sbit  EPINEN5_bit at UEP5.B1;
    const register unsigned short int EPOUTEN5 = 2;
    sbit  EPOUTEN5_bit at UEP5.B2;
    const register unsigned short int EPSTALL5 = 0;
    sbit  EPSTALL5_bit at UEP5.B0;

sfr unsigned short volatile UEP6             absolute 0xF76;
    const register unsigned short int EP6STALL = 0;
    sbit  EP6STALL_bit at UEP6.B0;
    const register unsigned short int EP6INEN = 1;
    sbit  EP6INEN_bit at UEP6.B1;
    const register unsigned short int EP6OUTEN = 2;
    sbit  EP6OUTEN_bit at UEP6.B2;
    const register unsigned short int EP6CONDIS = 3;
    sbit  EP6CONDIS_bit at UEP6.B3;
    const register unsigned short int EP6HSHK = 4;
    sbit  EP6HSHK_bit at UEP6.B4;
    const register unsigned short int EPCONDIS6 = 3;
    sbit  EPCONDIS6_bit at UEP6.B3;
    const register unsigned short int EPHSHK6 = 4;
    sbit  EPHSHK6_bit at UEP6.B4;
    const register unsigned short int EPINEN6 = 1;
    sbit  EPINEN6_bit at UEP6.B1;
    const register unsigned short int EPOUTEN6 = 2;
    sbit  EPOUTEN6_bit at UEP6.B2;
    const register unsigned short int EPSTALL6 = 0;
    sbit  EPSTALL6_bit at UEP6.B0;

sfr unsigned short volatile UEP7             absolute 0xF77;
    const register unsigned short int EP7STALL = 0;
    sbit  EP7STALL_bit at UEP7.B0;
    const register unsigned short int EP7INEN = 1;
    sbit  EP7INEN_bit at UEP7.B1;
    const register unsigned short int EP7OUTEN = 2;
    sbit  EP7OUTEN_bit at UEP7.B2;
    const register unsigned short int EP7CONDIS = 3;
    sbit  EP7CONDIS_bit at UEP7.B3;
    const register unsigned short int EP7HSHK = 4;
    sbit  EP7HSHK_bit at UEP7.B4;
    const register unsigned short int EPCONDIS7 = 3;
    sbit  EPCONDIS7_bit at UEP7.B3;
    const register unsigned short int EPHSHK7 = 4;
    sbit  EPHSHK7_bit at UEP7.B4;
    const register unsigned short int EPINEN7 = 1;
    sbit  EPINEN7_bit at UEP7.B1;
    const register unsigned short int EPOUTEN7 = 2;
    sbit  EPOUTEN7_bit at UEP7.B2;
    const register unsigned short int EPSTALL7 = 0;
    sbit  EPSTALL7_bit at UEP7.B0;

sfr unsigned short volatile UEP8             absolute 0xF78;
    const register unsigned short int EPSTALL8 = 0;
    sbit  EPSTALL8_bit at UEP8.B0;
    const register unsigned short int EPINEN8 = 1;
    sbit  EPINEN8_bit at UEP8.B1;
    const register unsigned short int EPOUTEN8 = 2;
    sbit  EPOUTEN8_bit at UEP8.B2;
    const register unsigned short int EPCONDIS8 = 3;
    sbit  EPCONDIS8_bit at UEP8.B3;
    const register unsigned short int EPHSHK8 = 4;
    sbit  EPHSHK8_bit at UEP8.B4;

sfr unsigned short volatile UEP9             absolute 0xF79;
    const register unsigned short int EPSTALL9 = 0;
    sbit  EPSTALL9_bit at UEP9.B0;
    const register unsigned short int EPINEN9 = 1;
    sbit  EPINEN9_bit at UEP9.B1;
    const register unsigned short int EPOUTEN9 = 2;
    sbit  EPOUTEN9_bit at UEP9.B2;
    const register unsigned short int EPCONDIS9 = 3;
    sbit  EPCONDIS9_bit at UEP9.B3;
    const register unsigned short int EPHSHK9 = 4;
    sbit  EPHSHK9_bit at UEP9.B4;

sfr unsigned short volatile UEP10            absolute 0xF7A;
    const register unsigned short int EPSTALL10 = 0;
    sbit  EPSTALL10_bit at UEP10.B0;
    const register unsigned short int EPINEN10 = 1;
    sbit  EPINEN10_bit at UEP10.B1;
    const register unsigned short int EPOUTEN10 = 2;
    sbit  EPOUTEN10_bit at UEP10.B2;
    const register unsigned short int EPCONDIS10 = 3;
    sbit  EPCONDIS10_bit at UEP10.B3;
    const register unsigned short int EPHSHK10 = 4;
    sbit  EPHSHK10_bit at UEP10.B4;

sfr unsigned short volatile UEP11            absolute 0xF7B;
    const register unsigned short int EPSTALL11 = 0;
    sbit  EPSTALL11_bit at UEP11.B0;
    const register unsigned short int EPINEN11 = 1;
    sbit  EPINEN11_bit at UEP11.B1;
    const register unsigned short int EPOUTEN11 = 2;
    sbit  EPOUTEN11_bit at UEP11.B2;
    const register unsigned short int EPCONDIS11 = 3;
    sbit  EPCONDIS11_bit at UEP11.B3;
    const register unsigned short int EPHSHK11 = 4;
    sbit  EPHSHK11_bit at UEP11.B4;

sfr unsigned short volatile UEP12            absolute 0xF7C;
    const register unsigned short int EPSTALL12 = 0;
    sbit  EPSTALL12_bit at UEP12.B0;
    const register unsigned short int EPINEN12 = 1;
    sbit  EPINEN12_bit at UEP12.B1;
    const register unsigned short int EPOUTEN12 = 2;
    sbit  EPOUTEN12_bit at UEP12.B2;
    const register unsigned short int EPCONDIS12 = 3;
    sbit  EPCONDIS12_bit at UEP12.B3;
    const register unsigned short int EPHSHK12 = 4;
    sbit  EPHSHK12_bit at UEP12.B4;

sfr unsigned short volatile UEP13            absolute 0xF7D;
    const register unsigned short int EPSTALL13 = 0;
    sbit  EPSTALL13_bit at UEP13.B0;
    const register unsigned short int EPINEN13 = 1;
    sbit  EPINEN13_bit at UEP13.B1;
    const register unsigned short int EPOUTEN13 = 2;
    sbit  EPOUTEN13_bit at UEP13.B2;
    const register unsigned short int EPCONDIS13 = 3;
    sbit  EPCONDIS13_bit at UEP13.B3;
    const register unsigned short int EPHSHK13 = 4;
    sbit  EPHSHK13_bit at UEP13.B4;

sfr unsigned short volatile UEP14            absolute 0xF7E;
    const register unsigned short int EPSTALL14 = 0;
    sbit  EPSTALL14_bit at UEP14.B0;
    const register unsigned short int EPINEN14 = 1;
    sbit  EPINEN14_bit at UEP14.B1;
    const register unsigned short int EPOUTEN14 = 2;
    sbit  EPOUTEN14_bit at UEP14.B2;
    const register unsigned short int EPCONDIS14 = 3;
    sbit  EPCONDIS14_bit at UEP14.B3;
    const register unsigned short int EPHSHK14 = 4;
    sbit  EPHSHK14_bit at UEP14.B4;

sfr unsigned short volatile UEP15            absolute 0xF7F;
    const register unsigned short int EPSTALL15 = 0;
    sbit  EPSTALL15_bit at UEP15.B0;
    const register unsigned short int EPINEN15 = 1;
    sbit  EPINEN15_bit at UEP15.B1;
    const register unsigned short int EPOUTEN15 = 2;
    sbit  EPOUTEN15_bit at UEP15.B2;
    const register unsigned short int EPCONDIS15 = 3;
    sbit  EPCONDIS15_bit at UEP15.B3;
    const register unsigned short int EPHSHK15 = 4;
    sbit  EPHSHK15_bit at UEP15.B4;
...
sfr unsigned short volatile CCP1AS           absolute 0xFB6;
...
sfr unsigned short volatile CCP1DEL          absolute 0xFB7;
...
sfr unsigned short volatile RCON             absolute 0xFD0;
    ...
    const register unsigned short int nIPEN = 7;
    sbit  nIPEN_bit at RCON.B7;
