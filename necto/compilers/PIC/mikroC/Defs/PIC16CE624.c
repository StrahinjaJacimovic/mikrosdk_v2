...
sfr unsigned short volatile EEINTF           absolute 0x0090;
...
sfr unsigned short volatile TRISB            absolute 0x0086;
    ...
    // EEINTF bits
    const register unsigned short int EEVDD = 0;
    sbit  EEVDD_bit at EEINTF.B0;
    const register unsigned short int EESDA = 1;
    sbit  EESDA_bit at EEINTF.B1;
    const register unsigned short int EESCL = 2;
    sbit  EESCL_bit at EEINTF.B2;
