...
sfr unsigned short volatile PORTJ            absolute 0xF88;
    ...
    const register unsigned short int nCE = 5;
    sbit  nCE_bit at PORTJ.B5;
    const register unsigned short int nLB = 6;
    sbit  nLB_bit at PORTJ.B6;
    const register unsigned short int nOE = 1;
    sbit  nOE_bit at PORTJ.B1;
    const register unsigned short int nUB = 7;
    sbit  nUB_bit at PORTJ.B7;
    const register unsigned short int nWRH = 3;
    sbit  nWRH_bit at PORTJ.B3;
    const register unsigned short int nWRL = 2;
    sbit  nWRL_bit at PORTJ.B2;
