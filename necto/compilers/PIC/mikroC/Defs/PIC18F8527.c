...
const unsigned long __FLASH_SIZE = 0x0000C000;
...
sfr unsigned short volatile SSP2CON2         absolute 0x0F62;
sfr unsigned short volatile SSP2CON1         absolute 0x0F63;
sfr unsigned short volatile SSP2STAT         absolute 0x0F64;
sfr unsigned short volatile SSP2ADD          absolute 0x0F65;
sfr unsigned short volatile SSP2BUF          absolute 0x0F66;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int ECCP2_PORTB = 3;
    sbit  ECCP2_PORTB_bit at PORTB.B3;
    ...
    // Alternative bit function
    const register unsigned short int ECCP2_PORTC = 1;
    sbit  ECCP2_PORTC_bit at PORTC.B1;
    ...
    // Alternative bit function
    const register unsigned short int ECCP2_PORTE = 7;
    sbit  ECCP2_PORTE_bit at PORTE.B7;
    ...
    // Alternative bit function
    const register unsigned short int P3C_PORTE = 3;
    sbit  P3C_PORTE_bit at PORTE.B3;

    // Alternative bit function
    const register unsigned short int P3B_PORTE = 4;
    sbit  P3B_PORTE_bit at PORTE.B4;

    // Alternative bit function
    const register unsigned short int P1C_PORTE = 5;
    sbit  P1C_PORTE_bit at PORTE.B5;

    // Alternative bit function
    const register unsigned short int P1B_PORTE = 6;
    ...
    // Alternative bit function
    const register unsigned short int P3C_PORTH = 4;
    sbit  P3C_PORTH_bit at PORTH.B4;

    // Alternative bit function
    const register unsigned short int P3B_PORTH = 5;
    sbit  P3B_PORTH_bit at PORTH.B5;

    // Alternative bit function
    const register unsigned short int P1C_PORTH = 6;
    sbit  P1C_PORTH_bit at PORTH.B6;

    // Alternative bit function
    const register unsigned short int P1B_PORTH = 7;
    sbit  P1B_PORTH_bit at PORTH.B7;
    ...
    // Alternative bit function
    const register unsigned short int NOT_OE = 1;
    sbit  NOT_OE_bit at PORTJ.B1;

    // Alternative bit function
    const register unsigned short int NOT_WRL = 2;
    sbit  NOT_WRL_bit at PORTJ.B2;

    // Alternative bit function
    const register unsigned short int NOT_WRH = 3;
    sbit  NOT_WRH_bit at PORTJ.B3;

    // Alternative bit function
    const register unsigned short int NOT_CE = 5;
    sbit  NOT_CE_bit at PORTJ.B5;

    // Alternative bit function
    const register unsigned short int NOT_LB = 6;
    sbit  NOT_LB_bit at PORTJ.B6;

    // Alternative bit function
    const register unsigned short int NOT_UB = 7;
    sbit  NOT_UB_bit at PORTJ.B7;
