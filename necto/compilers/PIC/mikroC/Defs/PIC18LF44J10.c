...
sfr unsigned short volatile SSP2CON2         absolute 0x0F85;
sfr unsigned short volatile SSP2CON1         absolute 0x0F86;
sfr unsigned short volatile SSP2STAT         absolute 0x0F87;
sfr unsigned short volatile SSP2ADD          absolute 0x0F88;
...
sfr unsigned short volatile SSP2BUF          absolute 0x0F8E;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int C1OUT_PORTB = 5;
    sbit  C1OUT_PORTB_bit at PORTB.B5;
    ...
    // Alternative bit function
    const register unsigned short int SDO2 = 2;
    sbit  SDO2_bit at PORTD.B2;
