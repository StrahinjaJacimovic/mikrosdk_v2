...
sfr unsigned short volatile TRIS             absolute 0x0085;
    ...
    const register unsigned short int SDA = 6;
    sbit  SDA_bit at GPIO.B6;

    // Alternative bit function
    const register unsigned short int SCL = 7;
    sbit  SCL_bit at GPIO.B7;
    ...
    // GPIO bits
    sbit  SCL_GPIO_bit at GPIO.B7;
    sbit  SDA_GPIO_bit at GPIO.B6;
