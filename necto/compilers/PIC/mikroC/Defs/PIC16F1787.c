...
sfr unsigned short volatile ODCOND           absolute 0x028F;
sfr unsigned short volatile ODCONE           absolute 0x0290;
...
sfr unsigned short volatile SLRCOND          absolute 0x030F;
sfr unsigned short volatile SLRCONE          absolute 0x0310;
...
sfr unsigned short volatile INLVLD           absolute 0x038F;
...
sfr unsigned short volatile OPA3CON          absolute 0x0515;
...
sfr unsigned short volatile PSMC3CON         absolute 0x0851;
sfr unsigned short volatile PSMC3MDL         absolute 0x0852;
sfr unsigned short volatile PSMC3SYNC        absolute 0x0853;
sfr unsigned short volatile PSMC3CLK         absolute 0x0854;
sfr unsigned short volatile PSMC3OEN         absolute 0x0855;
sfr unsigned short volatile PSMC3POL         absolute 0x0856;
sfr unsigned short volatile PSMC3BLNK        absolute 0x0857;
sfr unsigned short volatile PSMC3REBS        absolute 0x0858;
sfr unsigned short volatile PSMC3FEBS        absolute 0x0859;
sfr unsigned short volatile PSMC3PHS         absolute 0x085A;
sfr unsigned short volatile PSMC3DCS         absolute 0x085B;
sfr unsigned short volatile PSMC3PRS         absolute 0x085C;
sfr unsigned short volatile PSMC3ASDC        absolute 0x085D;
sfr unsigned short volatile PSMC3ASDL        absolute 0x085E;
sfr unsigned short volatile PSMC3ASDS        absolute 0x085F;
sfr unsigned short volatile PSMC3INT         absolute 0x0860;
sfr unsigned int   volatile PSMC3PH          absolute 0x0861;
sfr unsigned short volatile PSMC3PHL         absolute 0x0861;
sfr unsigned short volatile PSMC3PHH         absolute 0x0862;
sfr unsigned int   volatile PSMC3DC          absolute 0x0863;
sfr unsigned short volatile PSMC3DCL         absolute 0x0863;
sfr unsigned short volatile PSMC3DCH         absolute 0x0864;
sfr unsigned int   volatile PSMC3PR          absolute 0x0865;
sfr unsigned short volatile PSMC3PRL         absolute 0x0865;
sfr unsigned short volatile PSMC3PRH         absolute 0x0866;
sfr unsigned int   volatile PSMC3TMR         absolute 0x0867;
sfr unsigned short volatile PSMC3TMRL        absolute 0x0867;
sfr unsigned short volatile PSMC3TMRH        absolute 0x0868;
sfr unsigned short volatile PSMC3DBR         absolute 0x0869;
sfr unsigned short volatile PSMC3DBF         absolute 0x086A;
sfr unsigned short volatile PSMC3BLKR        absolute 0x086B;
sfr unsigned short volatile PSMC3BLKF        absolute 0x086C;
sfr unsigned short volatile PSMC3FFA         absolute 0x086D;
sfr unsigned short volatile PSMC3STR0        absolute 0x086E;
sfr unsigned short volatile PSMC3STR1        absolute 0x086F;
...
sfr unsigned short volatile TOSH             absolute 0x0FEF;
    ...
    // ODCOND bits
    const register unsigned short int ODCOND0 = 0;
    sbit  ODCOND0_bit at ODCOND.B0;
    const register unsigned short int ODCOND1 = 1;
    sbit  ODCOND1_bit at ODCOND.B1;
    const register unsigned short int ODCOND2 = 2;
    sbit  ODCOND2_bit at ODCOND.B2;
    const register unsigned short int ODCOND3 = 3;
    sbit  ODCOND3_bit at ODCOND.B3;
    const register unsigned short int ODCOND4 = 4;
    sbit  ODCOND4_bit at ODCOND.B4;
    const register unsigned short int ODCOND5 = 5;
    sbit  ODCOND5_bit at ODCOND.B5;
    const register unsigned short int ODCOND6 = 6;
    sbit  ODCOND6_bit at ODCOND.B6;
    const register unsigned short int ODCOND7 = 7;
    sbit  ODCOND7_bit at ODCOND.B7;

    // ODCONE bits
    const register unsigned short int ODCONE0 = 0;
    sbit  ODCONE0_bit at ODCONE.B0;
    const register unsigned short int ODCONE1 = 1;
    sbit  ODCONE1_bit at ODCONE.B1;
    const register unsigned short int ODCONE2 = 2;
    sbit  ODCONE2_bit at ODCONE.B2;
    ...
    // SLRCOND bits
    const register unsigned short int SLRCOND0 = 0;
    sbit  SLRCOND0_bit at SLRCOND.B0;
    const register unsigned short int SLRCOND1 = 1;
    sbit  SLRCOND1_bit at SLRCOND.B1;
    const register unsigned short int SLRCOND2 = 2;
    sbit  SLRCOND2_bit at SLRCOND.B2;
    const register unsigned short int SLRCOND3 = 3;
    sbit  SLRCOND3_bit at SLRCOND.B3;
    const register unsigned short int SLRCOND4 = 4;
    sbit  SLRCOND4_bit at SLRCOND.B4;
    const register unsigned short int SLRCOND5 = 5;
    sbit  SLRCOND5_bit at SLRCOND.B5;
    const register unsigned short int SLRCOND6 = 6;
    sbit  SLRCOND6_bit at SLRCOND.B6;
    const register unsigned short int SLRCOND7 = 7;
    sbit  SLRCOND7_bit at SLRCOND.B7;

    // SLRCONE bits
    const register unsigned short int SLRCONE0 = 0;
    sbit  SLRCONE0_bit at SLRCONE.B0;
    const register unsigned short int SLRCONE1 = 1;
    sbit  SLRCONE1_bit at SLRCONE.B1;
    const register unsigned short int SLRCONE2 = 2;
    sbit  SLRCONE2_bit at SLRCONE.B2;
    ...
    // OPA3CON bits
    const register unsigned short int OPA3PCH0 = 0;
    sbit  OPA3PCH0_bit at OPA3CON.B0;
    const register unsigned short int OPA3PCH1 = 1;
    sbit  OPA3PCH1_bit at OPA3CON.B1;
    ...
    const register unsigned short int P3OEC = 2;
    sbit  P3OEC_bit at PSMC3OEN.B2;
    const register unsigned short int P3OED = 3;
    sbit  P3OED_bit at PSMC3OEN.B3;
    const register unsigned short int P3OEE = 4;
    sbit  P3OEE_bit at PSMC3OEN.B4;
    const register unsigned short int P3OEF = 5;
    sbit  P3OEF_bit at PSMC3OEN.B5;
    ...
    const register unsigned short int P3POLC = 2;
    sbit  P3POLC_bit at PSMC3POL.B2;
    const register unsigned short int P3POLD = 3;
    sbit  P3POLD_bit at PSMC3POL.B3;
    const register unsigned short int P3POLE = 4;
    sbit  P3POLE_bit at PSMC3POL.B4;
    const register unsigned short int P3POLF = 5;
    sbit  P3POLF_bit at PSMC3POL.B5;
    ...
    const register unsigned short int P3ASDLC = 2;
    sbit  P3ASDLC_bit at PSMC3ASDL.B2;
    const register unsigned short int P3ASDLD = 3;
    sbit  P3ASDLD_bit at PSMC3ASDL.B3;
    const register unsigned short int P3ASDLE = 4;
    sbit  P3ASDLE_bit at PSMC3ASDL.B4;
    const register unsigned short int P3ASDLF = 5;
    sbit  P3ASDLF_bit at PSMC3ASDL.B5;
    ...
    const register unsigned short int P3STRC = 2;
    sbit  P3STRC_bit at PSMC3STR0.B2;
    const register unsigned short int P3STRD = 3;
    sbit  P3STRD_bit at PSMC3STR0.B3;
    const register unsigned short int P3STRE = 4;
    sbit  P3STRE_bit at PSMC3STR0.B4;
    const register unsigned short int P3STRF = 5;
    sbit  P3STRF_bit at PSMC3STR0.B5;
