...
sfr unsigned short volatile ADRES0           absolute 0x009B;
sfr unsigned short volatile ADRES0L          absolute 0x009B;
sfr unsigned short volatile ADRESL           absolute 0x009B;
sfr unsigned short volatile ADRES0H          absolute 0x009C;
...
sfr unsigned short volatile TOSH             absolute 0x0FEF;
    ...
    sbit  TRIGSEL0_bit at AADCON2.B4;
    const register unsigned short int TRIGSEL1 = 5;
    sbit  TRIGSEL1_bit at AADCON2.B5;
    const register unsigned short int TRIGSEL2 = 6;
    sbit  TRIGSEL2_bit at AADCON2.B6;
    ...
    const register unsigned short int ADOLEN = 5;
    sbit  ADOLEN_bit at AADCON3.B5;
