...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int CCP2A_PORTB = 3;
    sbit  CCP2A_PORTB_bit at PORTB.B3;
    ...
    // Alternative bit function
    const register unsigned short int CCP2A_PORTC = 1;
    sbit  CCP2A_PORTC_bit at PORTC.B1;
    ...
    // Alternative bit function
    const register unsigned short int AD08 = 0;
    sbit  AD08_bit at PORTE.B0;

    // Alternative bit function
    const register unsigned short int AD09 = 1;
    sbit  AD09_bit at PORTE.B1;
