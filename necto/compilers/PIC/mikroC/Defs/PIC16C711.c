...
sfr unsigned short volatile ADCON0           absolute 0x0008;
...
sfr unsigned short volatile PCON             absolute 0x0087;
sfr unsigned short volatile ADCON1           absolute 0x0088;
sfr unsigned short volatile PORTA            absolute 0x0005;
sfr unsigned short volatile PORTB            absolute 0x0006;
sfr unsigned short volatile ADRES            absolute 0x0009;
...
sfr unsigned short volatile TRISB            absolute 0x0086;
    ...
    const register unsigned short int ADIF = 1;
    sbit  ADIF_bit at ADCON0.B1;
