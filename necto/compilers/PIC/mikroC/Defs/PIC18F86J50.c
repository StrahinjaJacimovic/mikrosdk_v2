...
sfr unsigned int   volatile PMSTAT           absolute 0x0F40;
sfr unsigned short volatile PMSTATL          absolute 0x0F40;
sfr unsigned short volatile PMSTATH          absolute 0x0F41;
sfr unsigned short volatile PMEL             absolute 0x0F42;
sfr unsigned short volatile PMEN             absolute 0x0F42;
sfr unsigned short volatile PMEH             absolute 0x0F43;
sfr unsigned int   volatile PMDIN2           absolute 0x0F44;
sfr unsigned short volatile PMDIN2L          absolute 0x0F44;
sfr unsigned short volatile PMDIN2H          absolute 0x0F45;
sfr unsigned int   volatile PMDOUT2          absolute 0x0F46;
sfr unsigned short volatile PMDOUT2L         absolute 0x0F46;
sfr unsigned short volatile PMDOUT2H         absolute 0x0F47;
sfr unsigned int   volatile PMMODE           absolute 0x0F48;
sfr unsigned short volatile PMMODEL          absolute 0x0F48;
sfr unsigned short volatile PMMODEH          absolute 0x0F49;
sfr unsigned int   volatile PMCON            absolute 0x0F4A;
sfr unsigned short volatile PMCONL           absolute 0x0F4A;
sfr unsigned short volatile PMCONH           absolute 0x0F4B;
sfr unsigned short volatile UEP0             absolute 0x0F4C;
sfr unsigned short volatile UEP1             absolute 0x0F4D;
sfr unsigned short volatile UEP2             absolute 0x0F4E;
sfr unsigned short volatile UEP3             absolute 0x0F4F;
sfr unsigned short volatile UEP4             absolute 0x0F50;
sfr unsigned short volatile UEP5             absolute 0x0F51;
sfr unsigned short volatile UEP6             absolute 0x0F52;
sfr unsigned short volatile UEP7             absolute 0x0F53;
sfr unsigned short volatile UEP8             absolute 0x0F54;
sfr unsigned short volatile UEP9             absolute 0x0F55;
sfr unsigned short volatile UEP10            absolute 0x0F56;
sfr unsigned short volatile UEP11            absolute 0x0F57;
sfr unsigned short volatile UEP12            absolute 0x0F58;
sfr unsigned short volatile UEP13            absolute 0x0F59;
sfr unsigned short volatile UEP14            absolute 0x0F5A;
sfr unsigned short volatile UEP15            absolute 0x0F5B;
sfr unsigned short volatile UIE              absolute 0x0F5C;
sfr unsigned short volatile UEIE             absolute 0x0F5D;
sfr unsigned short volatile UADDR            absolute 0x0F5E;
sfr unsigned short volatile UCFG             absolute 0x0F5F;
...
sfr unsigned short volatile MEMCON           absolute 0x0FCB;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    const register unsigned short int DC5Y = 4;
    sbit  DC5Y_bit at CCP5CON.B4;
    const register unsigned short int DC5X = 5;
    sbit  DC5X_bit at CCP5CON.B5;
    ...
    const register unsigned short int DC4Y = 4;
    sbit  DC4Y_bit at CCP4CON.B4;
    const register unsigned short int DC4X = 5;
    sbit  DC4X_bit at CCP4CON.B5;
    ...
    // Alternative bit function
    const register unsigned short int C2INA = 5;
    sbit  C2INA_bit at PORTA.B5;
    ...
    // Alternative bit function
    const register unsigned short int PMD5_PORTA = 4;
    sbit  PMD5_PORTA_bit at PORTA.B4;

    // Alternative bit function
    const register unsigned short int PMD4_PORTA = 5;
    sbit  PMD4_PORTA_bit at PORTA.B5;
    ...
    // Alternative bit function
    const register unsigned short int PGC = 5;
    sbit  PGC_bit at PORTB.B5;

    // Alternative bit function
    const register unsigned short int PGD = 6;
    sbit  PGD_bit at PORTB.B6;
    ...
    // Alternative bit function
    const register unsigned short int C2OUT = 5;
    sbit  C2OUT_bit at PORTC.B5;

    // Alternative bit function
    const register unsigned short int PMD0_PORTD = 0;
    sbit  PMD0_PORTD_bit at PORTD.B0;

    // Alternative bit function
    const register unsigned short int PMD1_PORTD = 1;
    sbit  PMD1_PORTD_bit at PORTD.B1;

    // Alternative bit function
    const register unsigned short int PMD2_PORTD = 2;
    sbit  PMD2_PORTD_bit at PORTD.B2;

    // Alternative bit function
    const register unsigned short int PMD3_PORTD = 3;
    sbit  PMD3_PORTD_bit at PORTD.B3;

    // Alternative bit function
    const register unsigned short int PMD4_PORTD = 4;
    sbit  PMD4_PORTD_bit at PORTD.B4;

    // Alternative bit function
    const register unsigned short int PMD5_PORTD = 5;
    sbit  PMD5_PORTD_bit at PORTD.B5;

    // Alternative bit function
    const register unsigned short int PMD6_PORTD = 6;
    sbit  PMD6_PORTD_bit at PORTD.B6;

    // Alternative bit function
    const register unsigned short int PMD7_PORTD = 7;
    sbit  PMD7_PORTD_bit at PORTD.B7;
    ...
    // Alternative bit function
    const register unsigned short int PMRD_PORTE = 0;
    sbit  PMRD_PORTE_bit at PORTE.B0;

    // Alternative bit function
    const register unsigned short int PMWR_PORTE = 1;
    sbit  PMWR_PORTE_bit at PORTE.B1;

    // Alternative bit function
    const register unsigned short int PMBE_PORTE = 2;
    sbit  PMBE_PORTE_bit at PORTE.B2;
    ...
    // Alternative bit function
    const register unsigned short int C1OUT = 7;
    sbit  C1OUT_bit at PORTF.B7;
    ...
    // Alternative bit function
    const register unsigned short int PMD2_PORTF = 5;
    sbit  PMD2_PORTF_bit at PORTF.B5;

    // Alternative bit function
    const register unsigned short int PMD1_PORTF = 6;
    sbit  PMD1_PORTF_bit at PORTF.B6;

    // Alternative bit function
    const register unsigned short int PMD0_PORTF = 7;
    sbit  PMD0_PORTF_bit at PORTF.B7;
    ...
    // Alternative bit function
    const register unsigned short int PMD7_PORTH = 2;
    sbit  PMD7_PORTH_bit at PORTH.B2;

    // Alternative bit function
    const register unsigned short int PMD6_PORTH = 3;
    sbit  PMD6_PORTH_bit at PORTH.B3;

    // Alternative bit function
    const register unsigned short int PMD3_PORTH = 4;
    sbit  PMD3_PORTH_bit at PORTH.B4;

    // Alternative bit function
    const register unsigned short int PMBE_PORTH = 5;
    sbit  PMBE_PORTH_bit at PORTH.B5;

    // Alternative bit function
    const register unsigned short int PMRD_PORTH = 6;
    sbit  PMRD_PORTH_bit at PORTH.B6;

    // Alternative bit function
    const register unsigned short int PMWR_PORTH = 7;
    sbit  PMWR_PORTH_bit at PORTH.B7;
    ...
    const register unsigned short int EDBIS = 7;
    sbit  EDBIS_bit at MEMCON.B7;
    ...
    const register unsigned short int C1CH02 = 0;
    sbit  C1CH02_bit at CM2CON.B0;
    const register unsigned short int C1CH12 = 1;
    sbit  C1CH12_bit at CM2CON.B1;
    const register unsigned short int CREF2 = 2;
    sbit  CREF2_bit at CM2CON.B2;
    const register unsigned short int EVPOL02 = 3;
    sbit  EVPOL02_bit at CM2CON.B3;
    const register unsigned short int EVPOL12 = 4;
    sbit  EVPOL12_bit at CM2CON.B4;
    const register unsigned short int CPOL2 = 5;
    sbit  CPOL2_bit at CM2CON.B5;
    const register unsigned short int COE2 = 6;
    sbit  COE2_bit at CM2CON.B6;
    const register unsigned short int CON2 = 7;
    sbit  CON2_bit at CM2CON.B7;
    ...
    sbit  C1CH02_CM2CON1_bit at CM2CON1.B0;
    sbit  C1CH12_CM2CON1_bit at CM2CON1.B1;
    sbit  CREF2_CM2CON1_bit at CM2CON1.B2;
    sbit  EVPOL02_CM2CON1_bit at CM2CON1.B3;
    sbit  EVPOL12_CM2CON1_bit at CM2CON1.B4;
    sbit  CPOL2_CM2CON1_bit at CM2CON1.B5;
    sbit  COE2_CM2CON1_bit at CM2CON1.B6;
    sbit  CON2_CM2CON1_bit at CM2CON1.B7;
