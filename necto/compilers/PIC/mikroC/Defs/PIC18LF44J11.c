...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    const register unsigned short int P2DC02 = 0;
    sbit  P2DC02_bit at PSTR2CON.B0;
    const register unsigned short int P2DC12 = 1;
    sbit  P2DC12_bit at PSTR2CON.B1;
    const register unsigned short int P2DC22 = 2;
    sbit  P2DC22_bit at PSTR2CON.B2;
    const register unsigned short int P2DC32 = 3;
    sbit  P2DC32_bit at PSTR2CON.B3;
    const register unsigned short int P2DC42 = 4;
    sbit  P2DC42_bit at PSTR2CON.B4;
    const register unsigned short int P2DC52 = 5;
    sbit  P2DC52_bit at PSTR2CON.B5;
    const register unsigned short int P2DC62 = 6;
    sbit  P2DC62_bit at PSTR2CON.B6;
