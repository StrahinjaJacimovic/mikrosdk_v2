...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    sbit  PC3_bit at PORTE.B3;

    // Alternative bit function
    const register unsigned short int PB3 = 4;
    sbit  PB3_bit at PORTE.B4;

    // Alternative bit function
    const register unsigned short int PC1 = 5;
    sbit  PC1_bit at PORTE.B5;

    // Alternative bit function
    const register unsigned short int PB1 = 6;
    sbit  PB1_bit at PORTE.B6;
