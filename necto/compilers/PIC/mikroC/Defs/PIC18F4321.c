...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int C1N = 0;
    sbit  C1N_bit at PORTA.B0;

    // Alternative bit function
    const register unsigned short int C2N = 1;
    sbit  C2N_bit at PORTA.B1;

    // Alternative bit function
    const register unsigned short int C2P = 2;
    sbit  C2P_bit at PORTA.B2;

    // Alternative bit function
    const register unsigned short int C1P = 3;
    sbit  C1P_bit at PORTA.B3;
