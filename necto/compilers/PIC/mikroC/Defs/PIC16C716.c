...
sfr unsigned short volatile DATACCP          absolute 0x0007;
...
sfr unsigned short volatile TRISCCP          absolute 0x0087;
...
sfr unsigned short volatile TRISB            absolute 0x0086;
    ...
    // DATACCP bits
    const register unsigned short int DT1CK = 0;
    sbit  DT1CK_bit at DATACCP.B0;
    const register unsigned short int DCCP = 2;
    sbit  DCCP_bit at DATACCP.B2;
    ...
    // TRISCCP bits
    const register unsigned short int TT1CK = 0;
    sbit  TT1CK_bit at TRISCCP.B0;
    const register unsigned short int TCCP = 2;
    sbit  TCCP_bit at TRISCCP.B2;
