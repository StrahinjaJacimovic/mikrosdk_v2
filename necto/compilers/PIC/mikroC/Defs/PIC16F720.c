...
sfr unsigned short volatile TRISC            absolute 0x0087;
    ...
    // CCP1CON bits
    const register unsigned short int B1_ = 4;
    sbit  B1__bit at CCP1CON.B4;
    const register unsigned short int DC1 = 5;
    sbit  DC1_bit at CCP1CON.B5;
