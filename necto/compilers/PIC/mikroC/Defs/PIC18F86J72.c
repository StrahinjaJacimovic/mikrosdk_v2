...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    const register unsigned short int VCFG0_ADCON1 = 4;
    sbit  VCFG0_ADCON1_bit at ADCON1.B4;
    const register unsigned short int VCFG1_ADCON1 = 5;
    sbit  VCFG1_ADCON1_bit at ADCON1.B5;
    ...
    const register unsigned short int VCFG0_ADCON0 = 6;
    sbit  VCFG0_ADCON0_bit at ADCON0.B6;
    const register unsigned short int VCFG1_ADCON0 = 7;
    sbit  VCFG1_ADCON0_bit at ADCON0.B7;
