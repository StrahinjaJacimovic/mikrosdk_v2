...
sfr unsigned short volatile OSCTUN2          absolute 0x0F9A;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int CCP2A = 3;
    sbit  CCP2A_bit at PORTB.B3;
    ...
    // OSCTUN2 bits
    const register unsigned short int TUNSEL = 7;
    sbit  TUNSEL_bit at OSCTUN2.B7;
    const register unsigned short int TUN0 = 0;
    sbit  TUN0_bit at OSCTUN2.B0;
    const register unsigned short int TUN1 = 1;
    sbit  TUN1_bit at OSCTUN2.B1;
    const register unsigned short int TUN2 = 2;
    sbit  TUN2_bit at OSCTUN2.B2;
    const register unsigned short int TUN3 = 3;
    sbit  TUN3_bit at OSCTUN2.B3;
    const register unsigned short int TUN4 = 4;
    sbit  TUN4_bit at OSCTUN2.B4;
    const register unsigned short int TUN5 = 5;
    sbit  TUN5_bit at OSCTUN2.B5;

    // OSCTUNE bits
    sbit  TUN0_OSCTUNE_bit at OSCTUNE.B0;
    sbit  TUN1_OSCTUNE_bit at OSCTUNE.B1;
    sbit  TUN2_OSCTUNE_bit at OSCTUNE.B2;
    sbit  TUN3_OSCTUNE_bit at OSCTUNE.B3;
    sbit  TUN4_OSCTUNE_bit at OSCTUNE.B4;
    sbit  TUN5_OSCTUNE_bit at OSCTUNE.B5;
    ...
    const register unsigned short int DCP2Y = 4;
    sbit  DCP2Y_bit at CCP2CON.B4;
    const register unsigned short int DCP2X = 5;
    sbit  DCP2X_bit at CCP2CON.B5;
    ...
    const register unsigned short int DCP1Y = 4;
    sbit  DCP1Y_bit at CCP1CON.B4;
    const register unsigned short int DCP1X = 5;
    sbit  DCP1X_bit at CCP1CON.B5;
