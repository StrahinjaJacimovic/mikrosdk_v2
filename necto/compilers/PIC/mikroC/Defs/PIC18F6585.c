...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    const register unsigned short int RTRRO_TXLARB = 5;
    sbit  RTRRO_TXLARB_bit at B0CON.B5;
    ...
    sbit  RTRRO_TXLARB_B1CON_bit at B1CON.B5;
    ...
    sbit  RTRRO_TXLARB_B2CON_bit at B2CON.B5;
    ...
    sbit  RTRRO_TXLARB_B3CON_bit at B3CON.B5;
    ...
    sbit  RTRRO_TXLARB_B4CON_bit at B4CON.B5;
    ...
    sbit  RTRRO_TXLARB_B5CON_bit at B5CON.B5;
    ...
    const register unsigned short int EXIDM = 3;
    sbit  EXIDM_bit at RXM0SIDL.B3;
    ...
    const register unsigned short int RXRTRR0 = 3;
    sbit  RXRTRR0_bit at RXB1CON.B3;
    const register unsigned short int RTRRO_FILHIT3 = 3;
    sbit  RTRRO_FILHIT3_bit at RXB1CON.B3;
    ...
    const register unsigned short int RTRR0 = 5;
    sbit  RTRR0_bit at RXB0CON.B5;
    sbit  RTRRO_FILHIT3_RXB0CON_bit at RXB0CON.B3;
    ...
    sbit  ICODE0_bit at CANSTAT.B1;
    const register unsigned short int ICODE1 = 2;
    sbit  ICODE1_bit at CANSTAT.B2;
    const register unsigned short int ICODE2 = 3;
    sbit  ICODE2_bit at CANSTAT.B3;
