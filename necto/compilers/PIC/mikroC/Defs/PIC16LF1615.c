...
sfr unsigned short volatile SCANTRIG         absolute 0x71D;
    ...
    const register unsigned short int SCANTSEL4 = 4;
    sbit  SCANTSEL4_bit at SCANTRIG.B4;
    const register unsigned short int SCANTSEL5 = 5;
    sbit  SCANTSEL5_bit at SCANTRIG.B5;
    const register unsigned short int SCANTSEL6 = 6;
    sbit  SCANTSEL6_bit at SCANTRIG.B6;
    const register unsigned short int SCANTSEL7 = 7;
    sbit  SCANTSEL7_bit at SCANTRIG.B7;
    ...
    const register unsigned short int TSEL5 = 5;
    sbit  TSEL5_bit at SCANTRIG.B5;
    const register unsigned short int TSEL6 = 6;
    sbit  TSEL6_bit at SCANTRIG.B6;
    const register unsigned short int TSEL7 = 7;
    sbit  TSEL7_bit at SCANTRIG.B7;
