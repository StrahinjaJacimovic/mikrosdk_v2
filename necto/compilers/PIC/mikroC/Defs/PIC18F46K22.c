...
sfr unsigned short volatile ANSELD           absolute 0x0F3B;
sfr unsigned short volatile ANSELE           absolute 0x0F3C;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int P2B_PORTD = 2;
    sbit  P2B_PORTD_bit at PORTD.B2;

    // Alternative bit function
    const register unsigned short int P2C = 3;
    sbit  P2C_bit at PORTD.B3;

    // Alternative bit function
    const register unsigned short int P2D = 4;
    sbit  P2D_bit at PORTD.B4;
    ...
    // Alternative bit function
    const register unsigned short int CCP4 = 1;
    sbit  CCP4_bit at PORTD.B1;

    // Alternative bit function
    const register unsigned short int TX2 = 6;
    sbit  TX2_bit at PORTD.B6;

    // Alternative bit function
    const register unsigned short int RX2 = 7;
    sbit  RX2_bit at PORTD.B7;

    // Alternative bit function
    const register unsigned short int SCK2 = 0;
    sbit  SCK2_bit at PORTD.B0;

    // Alternative bit function
    const register unsigned short int SDI2 = 1;
    sbit  SDI2_bit at PORTD.B1;

    // Alternative bit function
    const register unsigned short int NOT_SS2 = 3;
    sbit  NOT_SS2_bit at PORTD.B3;
    ...
    sbit  CK2_bit at PORTD.B6;

    // Alternative bit function
    const register unsigned short int DT2 = 7;
    sbit  DT2_bit at PORTD.B7;
    ...
    // Alternative bit function
    const register unsigned short int SS2 = 3;
    sbit  SS2_bit at PORTD.B3;

    // Alternative bit function
    const register unsigned short int AN20 = 0;
    sbit  AN20_bit at PORTD.B0;

    // Alternative bit function
    const register unsigned short int AN21 = 1;
    sbit  AN21_bit at PORTD.B1;

    // Alternative bit function
    const register unsigned short int AN22 = 2;
    sbit  AN22_bit at PORTD.B2;

    // Alternative bit function
    const register unsigned short int AN23 = 3;
    sbit  AN23_bit at PORTD.B3;

    // Alternative bit function
    const register unsigned short int AN24 = 4;
    sbit  AN24_bit at PORTD.B4;

    // Alternative bit function
    const register unsigned short int AN25 = 5;
    sbit  AN25_bit at PORTD.B5;

    // Alternative bit function
    const register unsigned short int AN26 = 6;
    sbit  AN26_bit at PORTD.B6;

    // Alternative bit function
    const register unsigned short int AN27 = 7;
    sbit  AN27_bit at PORTD.B7;
    ...
    // Alternative bit function
    const register unsigned short int P3A_PORTE = 0;
    sbit  P3A_PORTE_bit at PORTE.B0;

    // Alternative bit function
    const register unsigned short int P3B = 1;
    sbit  P3B_bit at PORTE.B1;

    // Alternative bit function
    const register unsigned short int CCP5 = 2;
    sbit  CCP5_bit at PORTE.B2;
    ...
    // Alternative bit function
    const register unsigned short int CCP3_PORTE = 0;
    sbit  CCP3_PORTE_bit at PORTE.B0;
    ...
    sbit  EEADR8_bit at EEADRH.B0;
    const register unsigned short int EEADR9 = 1;
    sbit  EEADR9_bit at EEADRH.B1;
