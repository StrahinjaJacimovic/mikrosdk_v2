...
sfr unsigned short volatile SMT2CLK          absolute 0xDAD;
    ...
    sbit  CSEL3_bit at SMT2CLK.B3;
    const register unsigned short int CSEL4 = 4;
    sbit  CSEL4_bit at SMT2CLK.B4;
    const register unsigned short int CSEL5 = 5;
    sbit  CSEL5_bit at SMT2CLK.B5;
    const register unsigned short int CSEL6 = 6;
    sbit  CSEL6_bit at SMT2CLK.B6;
    const register unsigned short int CSEL7 = 7;
    sbit  CSEL7_bit at SMT2CLK.B7;
...
sfr unsigned short volatile SMT2SIG          absolute 0xDAE;
    ...
    sbit  SSEL3_bit at SMT2SIG.B3;
    const register unsigned short int SSEL4 = 4;
    sbit  SSEL4_bit at SMT2SIG.B4;
    const register unsigned short int SSEL5 = 5;
    sbit  SSEL5_bit at SMT2SIG.B5;
    const register unsigned short int SSEL6 = 6;
    sbit  SSEL6_bit at SMT2SIG.B6;
    const register unsigned short int SSEL7 = 7;
    sbit  SSEL7_bit at SMT2SIG.B7;
...
sfr unsigned short volatile SMT2WIN          absolute 0xDAF;
    ...
    sbit  WSEL4_bit at SMT2WIN.B4;
    const register unsigned short int WSEL5 = 5;
    sbit  WSEL5_bit at SMT2WIN.B5;
    const register unsigned short int WSEL6 = 6;
    sbit  WSEL6_bit at SMT2WIN.B6;
    const register unsigned short int WSEL7 = 7;
    sbit  WSEL7_bit at SMT2WIN.B7;
