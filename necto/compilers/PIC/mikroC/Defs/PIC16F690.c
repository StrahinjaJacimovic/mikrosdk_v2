...
sfr unsigned short          PWM1CON          absolute 0x001C;
sfr unsigned short volatile ECCPAS           absolute 0x001D;
...
sfr unsigned short          BAUDCTL          absolute 0x009B;
...
sfr unsigned int   volatile CCPR             absolute 0x0015;
...
sfr unsigned short volatile TRISC            absolute 0x0087;
    ...
    const register unsigned short int SENB = 3;
    sbit  SENB_bit at TXSTA.B3;
