...
sfr unsigned short volatile TOSH             absolute 0x0FEF;
    ...
    // Alternative bit function
    const register unsigned short int C12IN0N = 1;
    sbit  C12IN0N_bit at PORTA.B1;
    ...
    // Alternative bit function
    const register unsigned short int NOT_SS = 3;
    sbit  NOT_SS_bit at PORTA.B3;

    // Alternative bit function
    const register unsigned short int SDO_PORTA = 4;
    sbit  SDO_PORTA_bit at PORTA.B4;

    // Alternative bit function
    const register unsigned short int TX_PORTA = 0;
    sbit  TX_PORTA_bit at PORTA.B0;

    // Alternative bit function
    const register unsigned short int RX_PORTA = 1;
    sbit  RX_PORTA_bit at PORTA.B1;
    ...
    // Alternative bit function
    const register unsigned short int CK_PORTA = 0;
    sbit  CK_PORTA_bit at PORTA.B0;

    // Alternative bit function
    const register unsigned short int DT_PORTA = 1;
    sbit  DT_PORTA_bit at PORTA.B1;
    ...
    // Alternative bit function
    const register unsigned short int CPS4 = 0;
    sbit  CPS4_bit at PORTC.B0;

    // Alternative bit function
    const register unsigned short int CPS5 = 1;
    sbit  CPS5_bit at PORTC.B1;

    // Alternative bit function
    const register unsigned short int CPS6 = 2;
    sbit  CPS6_bit at PORTC.B2;

    // Alternative bit function
    const register unsigned short int CPS7 = 3;
    sbit  CPS7_bit at PORTC.B3;

    // Alternative bit function
    const register unsigned short int C2INP = 0;
    sbit  C2INP_bit at PORTC.B0;

    // Alternative bit function
    const register unsigned short int C12IN1N = 1;
    sbit  C12IN1N_bit at PORTC.B1;

    // Alternative bit function
    const register unsigned short int C12IN2N = 2;
    sbit  C12IN2N_bit at PORTC.B2;

    // Alternative bit function
    const register unsigned short int C12IN3N = 3;
    sbit  C12IN3N_bit at PORTC.B3;

    // Alternative bit function
    const register unsigned short int C2OUT_PORTC = 4;
    sbit  C2OUT_PORTC_bit at PORTC.B4;

    // Alternative bit function
    const register unsigned short int SCL = 0;
    sbit  SCL_bit at PORTC.B0;

    // Alternative bit function
    const register unsigned short int SDA = 1;
    sbit  SDA_bit at PORTC.B1;
    ...
    // Alternative bit function
    const register unsigned short int SCK = 0;
    sbit  SCK_bit at PORTC.B0;

    // Alternative bit function
    const register unsigned short int SDI = 1;
    sbit  SDI_bit at PORTC.B1;

    // Alternative bit function
    const register unsigned short int SDO_PORTC = 2;

    // Alternative bit function
    sbit  SDO_PORTC_bit at PORTC.B2;
    sbit  NOT_SS_PORTC_bit at PORTC.B3;

    // Alternative bit function
    const register unsigned short int SRNQ = 4;
    sbit  SRNQ_bit at PORTC.B4;
    ...
    sbit  MDCIN1_bit at PORTC.B2;

    // Alternative bit function
    const register unsigned short int MDMIN = 3;
    sbit  MDMIN_bit at PORTC.B3;

    // Alternative bit function
    const register unsigned short int MDOUT_PORTC = 4;
    sbit  MDOUT_PORTC_bit at PORTC.B4;

    // Alternative bit function
    const register unsigned short int MDCIN2 = 5;
    sbit  MDCIN2_bit at PORTC.B5;

    // Alternative bit function
    const register unsigned short int TX_PORTC = 4;
    sbit  TX_PORTC_bit at PORTC.B4;

    // Alternative bit function
    const register unsigned short int RX_PORTC = 5;
    sbit  RX_PORTC_bit at PORTC.B5;

    // Alternative bit function
    const register unsigned short int CK_PORTC = 4;
    sbit  CK_PORTC_bit at PORTC.B4;

    // Alternative bit function
    const register unsigned short int DT_PORTC = 5;
    sbit  DT_PORTC_bit at PORTC.B5;
