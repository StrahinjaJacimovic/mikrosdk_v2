...
sfr unsigned short volatile RPOR19           absolute 0x0ED9;
sfr unsigned short volatile RPOR20           absolute 0x0EDA;
sfr unsigned short volatile RPOR21           absolute 0x0EDB;
sfr unsigned short volatile RPOR22           absolute 0x0EDC;
sfr unsigned short volatile RPOR23           absolute 0x0EDD;
sfr unsigned short volatile RPOR24           absolute 0x0EDE;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int T1CK = 0;
    sbit  T1CK_bit at PORTC.B0;
    ...
    const register unsigned short int S1 = 3;
    sbit  S1_bit at SSP1STAT.B3;
    const register unsigned short int P1 = 4;
    sbit  P1_bit at SSP1STAT.B4;
    ...
    const register unsigned short int R1_ = 2;
    sbit  R1__bit at SSP1STAT.B2;
    const register unsigned short int D1 = 5;
    sbit  D1_bit at SSP1STAT.B5;
    const register unsigned short int D_A1 = 2;
    sbit  D_A1_bit at SSP1STAT.B2;
    const register unsigned short int R_W1 = 5;
    sbit  R_W1_bit at SSP1STAT.B5;
    const register unsigned short int NOT_W1 = 2;
    sbit  NOT_W1_bit at SSP1STAT.B2;
    const register unsigned short int NOT_A1 = 5;
    sbit  NOT_A1_bit at SSP1STAT.B5;
    ...
    const register unsigned short int T1SYNC1 = 2;
    sbit  T1SYNC1_bit at T1CON.B2;
    const register unsigned short int T1OSCEN1 = 3;
    sbit  T1OSCEN1_bit at T1CON.B3;
    const register unsigned short int T1CKPS01 = 4;
    sbit  T1CKPS01_bit at T1CON.B4;
    const register unsigned short int T1CKPS11 = 5;
    sbit  T1CKPS11_bit at T1CON.B5;
    const register unsigned short int TMR1CS01 = 6;
    sbit  TMR1CS01_bit at T1CON.B6;
    const register unsigned short int TMR1CS11 = 7;
    sbit  TMR1CS11_bit at T1CON.B7;
    ...
    const register unsigned short int CCH01 = 0;
    sbit  CCH01_bit at CM1CON.B0;
    const register unsigned short int CCH11 = 1;
    sbit  CCH11_bit at CM1CON.B1;
    const register unsigned short int CREF1 = 2;
    sbit  CREF1_bit at CM1CON.B2;
    const register unsigned short int EVPOL01 = 3;
    sbit  EVPOL01_bit at CM1CON.B3;
    const register unsigned short int EVPOL11 = 4;
    sbit  EVPOL11_bit at CM1CON.B4;
    const register unsigned short int CPOL1 = 5;
    sbit  CPOL1_bit at CM1CON.B5;
    const register unsigned short int COE1 = 6;
    sbit  COE1_bit at CM1CON.B6;
    const register unsigned short int CON1 = 7;
    sbit  CON1_bit at CM1CON.B7;
    ...
    sbit  CCH01_CM1CON1_bit at CM1CON1.B0;
    sbit  CCH11_CM1CON1_bit at CM1CON1.B1;
    sbit  CREF1_CM1CON1_bit at CM1CON1.B2;
    sbit  EVPOL01_CM1CON1_bit at CM1CON1.B3;
    sbit  EVPOL11_CM1CON1_bit at CM1CON1.B4;
    sbit  CPOL1_CM1CON1_bit at CM1CON1.B5;
    sbit  COE1_CM1CON1_bit at CM1CON1.B6;
    sbit  CON1_CM1CON1_bit at CM1CON1.B7;
    ...
    sbit  REPU_PORTE_bit at PORTE.B6;
