...
sfr unsigned short volatile TRIS             absolute 0x0085;
    ...
    const register unsigned short int LINRX = 6;
    sbit  LINRX_bit at STATUS.B6;
    const register unsigned short int LINTX = 7;

    // Alternative bit function
    sbit  LINTX_bit at STATUS.B7;

    // Alternative bit function
    sbit  LINRX_GPIO_bit at GPIO.B6;
    sbit  LINTX_GPIO_bit at GPIO.B7;
