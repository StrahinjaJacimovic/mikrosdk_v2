...
sfr unsigned short volatile PIR2             absolute 0x012;
    ...
    const register unsigned short int SSP2IF = 3;
    sbit  SSP2IF_bit at PIR2.B3;
    ...
    const register unsigned short int TMR6IF = 7;
    sbit  TMR6IF_bit at PIR2.B7;
...
sfr unsigned short volatile PIR3             absolute 0x013;
    ...
    sbit  TMR3IF_bit at PIR3.B4;
    const register unsigned short int TMR3GIF = 5;
    sbit  TMR3GIF_bit at PIR3.B5;
...
sfr unsigned short volatile PIR4             absolute 0x014;
    ...
    sbit  CCP3IF_bit at PIR4.B2;
    const register unsigned short int CCP4IF = 3;
    sbit  CCP4IF_bit at PIR4.B3;
    ...
    const register unsigned short int CWG2IF = 7;
    sbit  CWG2IF_bit at PIR4.B7;
...
sfr unsigned short volatile PIE2             absolute 0x092;
    ...
    const register unsigned short int SSP2IE = 3;
    sbit  SSP2IE_bit at PIE2.B3;
    ...
    const register unsigned short int TMR6IE = 7;
    sbit  TMR6IE_bit at PIE2.B7;
...
sfr unsigned short volatile PIE3             absolute 0x093;
    ...
    sbit  TMR3IE_bit at PIE3.B4;
    const register unsigned short int TMR3GIE = 5;
    sbit  TMR3GIE_bit at PIE3.B5;
...
sfr unsigned short volatile PIE4             absolute 0x094;
    ...
    sbit  CCP3IE_bit at PIE4.B2;
    const register unsigned short int CCP4IE = 3;
    sbit  CCP4IE_bit at PIE4.B3;
    ...
    const register unsigned short int CWG2IE = 7;
    sbit  CWG2IE_bit at PIE4.B7;
...
sfr unsigned short volatile CCPTMRS          absolute 0x29F;
...
sfr unsigned short volatile CCP3CAP          absolute 0x314;
    const register unsigned short int CCAP0 = 0;
    sbit  CCAP0_bit at CCP3CAP.B0;
    const register unsigned short int CCAP1 = 1;
    sbit  CCAP1_bit at CCP3CAP.B1;
    const register unsigned short int CCAP2 = 2;
    sbit  CCAP2_bit at CCP3CAP.B2;
    const register unsigned short int CCAP3 = 3;
    sbit  CCAP3_bit at CCP3CAP.B3;
...
sfr unsigned int   volatile CCPR4            absolute 0x315;
sfr unsigned short volatile CCPR4L           absolute 0x315;
sfr unsigned short volatile CCPR4H           absolute 0x316;
sfr unsigned short volatile CCP4CON          absolute 0x317;
...
sfr unsigned short volatile CCP4CAP          absolute 0x318;
...
sfr unsigned int   volatile TMR3             absolute 0x411;
sfr unsigned short volatile TMR3L            absolute 0x411;
sfr unsigned short volatile TMR3H            absolute 0x412;
sfr unsigned short volatile T3CON            absolute 0x413;
    ...
    const register unsigned short int T3SOSC = 3;
    sbit  T3SOSC_bit at T3CON.B3;
...
sfr unsigned short volatile T3GCON           absolute 0x414;
...
sfr unsigned int   volatile TMR5             absolute 0x418;
sfr unsigned short volatile TMR5L            absolute 0x418;
sfr unsigned short volatile TMR5H            absolute 0x419;
sfr unsigned short volatile T5CON            absolute 0x41A;
    ...
    const register unsigned short int T5SOSC = 3;
    sbit  T5SOSC_bit at T5CON.B3;
...
sfr unsigned short volatile T5GCON           absolute 0x41B;
...
sfr unsigned short volatile CCDCON           absolute 0x41F;
...
sfr unsigned short volatile CWG2CLKCON       absolute 0x711;
    const register unsigned short int CWG2CS = 0;
    sbit  CWG2CS_bit at CWG2CLKCON.B0;

sfr unsigned short volatile CWG2DAT          absolute 0x712;
    const register unsigned short int CWG2DAT0 = 0;
    sbit  CWG2DAT0_bit at CWG2DAT.B0;
    const register unsigned short int CWG2DAT1 = 1;
    sbit  CWG2DAT1_bit at CWG2DAT.B1;
    const register unsigned short int CWG2DAT2 = 2;
    sbit  CWG2DAT2_bit at CWG2DAT.B2;
    const register unsigned short int CWG2DAT3 = 3;
    sbit  CWG2DAT3_bit at CWG2DAT.B3;

sfr unsigned short volatile CWG2DBR          absolute 0x713;
...
sfr unsigned short volatile CWG2DBF          absolute 0x714;
...
sfr unsigned short volatile CWG2CON0         absolute 0x715;
...
sfr unsigned short volatile CWG2CON1         absolute 0x716;
...
sfr unsigned short volatile CWG2AS0          absolute 0x717;
...
sfr unsigned short volatile CWG2AS1          absolute 0x718;
sfr unsigned short volatile CWG2STR          absolute 0x719;
...
sfr unsigned short volatile PMD3             absolute 0x914;
    ...
    const register unsigned short int CWG2MD = 7;
    sbit  CWG2MD_bit at PMD3.B7;

sfr unsigned short volatile PMD4             absolute 0x915;
    const register unsigned short int MSSP1MD = 1;
    sbit  MSSP1MD_bit at PMD4.B1;
    const register unsigned short int MSSP2MD = 2;
    sbit  MSSP2MD_bit at PMD4.B2;
...
sfr unsigned short volatile CCP3PPS          absolute 0xE16;
...
sfr unsigned short volatile CCP4PPS          absolute 0xE17;
...
sfr unsigned short volatile CWG2PPS          absolute 0xE19;
...
sfr unsigned short volatile SSP2CLKPPS       absolute 0xE1D;
...
sfr unsigned short volatile SSP2DATPPS       absolute 0xE1E;
...
sfr unsigned short volatile SSP2SSPPS        absolute 0xE1F;
...
sfr unsigned short volatile RXPPS            absolute 0xE24;
    const register unsigned short int RXDTPPS0 = 0;
    sbit  RXDTPPS0_bit at RXPPS.B0;
    const register unsigned short int RXDTPPS1 = 1;
    sbit  RXDTPPS1_bit at RXPPS.B1;
    const register unsigned short int RXDTPPS2 = 2;
    sbit  RXDTPPS2_bit at RXPPS.B2;
    const register unsigned short int RXDTPPS3 = 3;
    sbit  RXDTPPS3_bit at RXPPS.B3;
    const register unsigned short int RXDTPPS4 = 4;
    sbit  RXDTPPS4_bit at RXPPS.B4;

sfr unsigned short volatile TXPPS            absolute 0xE25;
    const register unsigned short int TXCKPPS0 = 0;
    sbit  TXCKPPS0_bit at TXPPS.B0;
    const register unsigned short int TXCKPPS1 = 1;
    sbit  TXCKPPS1_bit at TXPPS.B1;
    const register unsigned short int TXCKPPS2 = 2;
    sbit  TXCKPPS2_bit at TXPPS.B2;
    const register unsigned short int TXCKPPS3 = 3;
    sbit  TXCKPPS3_bit at TXPPS.B3;
    const register unsigned short int TXCKPPS4 = 4;
    sbit  TXCKPPS4_bit at TXPPS.B4;
...
sfr unsigned short volatile T3CKIPPS         absolute 0xE2C;
sfr unsigned short volatile T3GPPS           absolute 0xE2D;
sfr unsigned short volatile T5CKIPPS         absolute 0xE2E;
sfr unsigned short volatile T5GPPS           absolute 0xE2F;
