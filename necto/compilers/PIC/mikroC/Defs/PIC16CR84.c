...
sfr unsigned short volatile EEDATA           absolute 0x0008;
sfr unsigned short volatile EEADR            absolute 0x0009;
...
sfr unsigned short volatile EECON1           absolute 0x0088;
sfr unsigned short volatile EECON2           absolute 0x0089;
