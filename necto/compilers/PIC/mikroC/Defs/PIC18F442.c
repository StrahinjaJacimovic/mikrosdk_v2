...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int CCP2_TRISB = 3;
    sbit  CCP2_TRISB_bit at TRISB.B3;

    // Alternative bit function
    const register unsigned short int CCP2_TRISC = 1;

    // Alternative bit function
    sbit  CCP2_TRISC_bit at TRISC.B1;
