...
sfr unsigned short volatile TSTOUT           absolute 0x0F65;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int T13CKI = 5;
    sbit  T13CKI_bit at PORTA.B5;
    ...
    // Alternative bit function
    const register unsigned short int C12IN0M = 1;
    sbit  C12IN0M_bit at PORTA.B1;
    ...
    // Alternative bit function
    const register unsigned short int VREFM = 0;
    sbit  VREFM_bit at PORTA.B0;

    // Alternative bit function
    const register unsigned short int VREFP = 1;
    sbit  VREFP_bit at PORTA.B1;
    ...
    sbit  INT2_bit at PORTA.B2;

    // Alternative bit function
    const register unsigned short int PGD = 0;
    sbit  PGD_bit at PORTA.B0;

    // Alternative bit function
    const register unsigned short int PGC = 1;
    sbit  PGC_bit at PORTA.B1;

    // Alternative bit function
    const register unsigned short int VPP = 3;
    sbit  VPP_bit at PORTA.B3;
    ...
    const register unsigned short int D1NSS0 = 0;
    sbit  D1NSS0_bit at REFCON1.B0;
