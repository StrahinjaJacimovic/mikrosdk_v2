...
const unsigned long __FLASH_SIZE = 0x0000BFF8;
...
sfr unsigned short volatile TOSU             absolute 0x0FFF;
    ...
    // Alternative bit function
    const register unsigned short int AD00 = 0;
    sbit  AD00_bit at PORTD.B0;

    // Alternative bit function
    const register unsigned short int AD01 = 1;
    sbit  AD01_bit at PORTD.B1;

    // Alternative bit function
    const register unsigned short int AD02 = 2;
    sbit  AD02_bit at PORTD.B2;

    // Alternative bit function
    const register unsigned short int AD03 = 3;
    sbit  AD03_bit at PORTD.B3;

    // Alternative bit function
    const register unsigned short int AD04 = 4;
    sbit  AD04_bit at PORTD.B4;

    // Alternative bit function
    const register unsigned short int AD05 = 5;
    sbit  AD05_bit at PORTD.B5;

    // Alternative bit function
    const register unsigned short int AD06 = 6;
    sbit  AD06_bit at PORTD.B6;

    // Alternative bit function
    const register unsigned short int AD07 = 7;
    sbit  AD07_bit at PORTD.B7;
    ...
    // Alternative bit function
    const register unsigned short int CVREF = 3;
    sbit  CVREF_bit at PORTF.B3;
    ...
    const register unsigned short int CCPIP = 2;
    sbit  CCPIP_bit at IPR1.B2;
