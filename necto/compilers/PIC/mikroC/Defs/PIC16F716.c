...
sfr unsigned short volatile DATACCP          absolute 0x0006;
...
sfr unsigned short          PWM1CON          absolute 0x0018;
sfr unsigned short volatile ECCPAS           absolute 0x0019;
...
sfr unsigned short volatile TRISB            absolute 0x0086;
    ...
    // DATACCP bits
    const register unsigned short int DT1CK = 1;
    sbit  DT1CK_bit at DATACCP.B1;
    const register unsigned short int DCCP = 3;

    // Alternative bit function
    sbit  DCCP_bit at DATACCP.B3;

    // Alternative bit function
    sbit  DT1CK_PORTB_bit at PORTB.B1;
    sbit  DCCP_PORTB_bit at PORTB.B3;
    ...
    // Alternative bit function
    const register unsigned short int TT1CK = 1;
    sbit  TT1CK_bit at TRISB.B1;

    // Alternative bit function
    const register unsigned short int TCCP = 3;
    sbit  TCCP_bit at TRISB.B3;
